---
id: tutorial/general/claude
title: CLAUDE
category: tutorial
tags: ["claude", "context", "first", "mandatory:", "non-negotiable"]
---

# Claude Code Context

> **Context**: This document provides context for Claude (and other AI tools) working on this codebase.
