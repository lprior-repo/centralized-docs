...
// Validation schema for bead: centralized-docs-20260402083758-5h3ftars
// Title: data: add fixed-size `FileStateRaw` and `UrlStateRaw` pod types
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402083758-5h3ftars.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402083758-5h3ftars"
  title: "data: add fixed-size `FileStateRaw` and `UrlStateRaw` pod types"
