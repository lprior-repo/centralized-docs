...
// Validation schema for bead: centralized-docs-20260402080717-jqldjpoy
// Title: action: capture transform artifacts by source path and reuse archived transforms
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402080717-jqldjpoy.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402080717-jqldjpoy"
  title: "action: capture transform artifacts by source path and reuse archived transforms"
