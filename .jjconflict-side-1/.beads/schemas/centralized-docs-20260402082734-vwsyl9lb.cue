...
// Validation schema for bead: centralized-docs-20260402082734-vwsyl9lb
// Title: data: remove LRU backend from `CacheBackendInner` after state migration
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402082734-vwsyl9lb.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402082734-vwsyl9lb"
  title: "data: remove LRU backend from `CacheBackendInner` after state migration"
