...
// Validation schema for bead: centralized-docs-20260402082734-s2tvhnm7
// Title: data: add fixed-size `FileStateRaw` and `UrlStateRaw` pod types
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402082734-s2tvhnm7.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402082734-s2tvhnm7"
  title: "data: add fixed-size `FileStateRaw` and `UrlStateRaw` pod types"
