...
// Validation schema for bead: centralized-docs-20260402080950-9knyln5n
// Title: action: wire scrape command to one shared read session and one shutdown commit
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402080950-9knyln5n.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402080950-9knyln5n"
  title: "action: wire scrape command to one shared read session and one shutdown commit"
