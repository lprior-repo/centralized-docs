...
// Validation schema for bead: centralized-docs-20260402082447-bc4g8yc2
// Title: data: remove LRU backend from `CacheBackendInner` after state migration
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402082447-bc4g8yc2.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402082447-bc4g8yc2"
  title: "data: remove LRU backend from `CacheBackendInner` after state migration"
