...
// Validation schema for bead: centralized-docs-20260402083214-qghjssbi
// Title: data: implement archived output bulk loaders with transform reuse coverage
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402083214-qghjssbi.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402083214-qghjssbi"
  title: "data: implement archived output bulk loaders with transform reuse coverage"
