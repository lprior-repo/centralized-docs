---
id: concept/fastapi.md/fastapi
title: FastAPI Background Tasks And PostgreSQL
category: concept
tags: ["background", "blocking", "concept", "fastapi", "postgresql"]
---
...
# FastAPI Background Tasks and PostgreSQL
 ...
 > 
 > **Context**: To yield a dependency in FastAPI using a Background Task, you must not yield inside the background task itself. Instead, yield in the main dependency 
