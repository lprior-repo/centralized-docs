...
chunk_id: concept/fastapi.md/fastapi#1-standard
chunk_level: standard
chunk_type: prose
heading: Tokio Spawn vs Spawn Blocking
token_count: 185
summary: # FastAPI Background Tasks and PostgreSQL. For PostgreSQL connection pools with asyncpg during high concurrency, set `min_size` and `max_size` carefully in the `create_pool` function to avoid conne...
---
