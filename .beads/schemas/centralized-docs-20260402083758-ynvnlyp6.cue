...
// Validation schema for bead: centralized-docs-20260402083758-ynvnlyp6
// Title: data: add explicit snapshot APIs on `StateReadSession` and `StateDb`
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402083758-ynvnlyp6.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402083758-ynvnlyp6"
  title: "data: add explicit snapshot APIs on `StateReadSession` and `StateDb`"
