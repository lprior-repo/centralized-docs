...
// Validation schema for bead: centralized-docs-20260402083758-kzkqh2uq
// Title: data: add `StateReadSession` to enforce one shared read transaction per run
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402083758-kzkqh2uq.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402083758-kzkqh2uq"
  title: "data: add `StateReadSession` to enforce one shared read transaction per run"
