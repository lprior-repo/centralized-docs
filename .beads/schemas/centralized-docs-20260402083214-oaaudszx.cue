...
// Validation schema for bead: centralized-docs-20260402083214-oaaudszx
// Title: action: wire scrape command to one shared read session and one shutdown commit
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402083214-oaaudszx.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402083214-oaaudszx"
  title: "action: wire scrape command to one shared read session and one shutdown commit"
