...
// Validation schema for bead: centralized-docs-20260402082447-o0t4xctw
// Title: action: migrate watch/apply snapshot persistence from `DocCache` to `StateDb`
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402082447-o0t4xctw.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402082447-o0t4xctw"
  title: "action: migrate watch/apply snapshot persistence from `DocCache` to `StateDb`"
