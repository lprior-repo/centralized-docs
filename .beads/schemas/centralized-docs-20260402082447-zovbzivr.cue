...
// Validation schema for bead: centralized-docs-20260402082447-zovbzivr
// Title: calc: expose deterministic config hashing and add `compute_file_diff`
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402082447-zovbzivr.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402082447-zovbzivr"
  title: "calc: expose deterministic config hashing and add `compute_file_diff`"
