...
// Validation schema for bead: centralized-docs-20260402075248-wnyslmne
// Title: data: remove LRU backend from `CacheBackendInner` after state migration
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402075248-wnyslmne.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402075248-wnyslmne"
  title: "data: remove LRU backend from `CacheBackendInner` after state migration"
