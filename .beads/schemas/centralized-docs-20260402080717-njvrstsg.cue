...
// Validation schema for bead: centralized-docs-20260402080717-njvrstsg
// Title: action: migrate watch/apply snapshot persistence from `DocCache` to `StateDb`
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402080717-njvrstsg.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402080717-njvrstsg"
  title: "action: migrate watch/apply snapshot persistence from `DocCache` to `StateDb`"
