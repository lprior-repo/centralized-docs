---
url: https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-custom-domain-names-ip-address-type.html
title: IP address types for custom domain names for HTTP APIs
word_count: 441
filtered: true
elements_removed: 0
density_score: 0.86
...
IP address types for custom domain names for HTTP APIs - Amazon API Gateway
[](https://docs.aws.amazon.com/pdfs/apigateway/latest/developerguide/apigateway-dg.pdf#http-api-custom-domain-names-ip-address-type)
[Considerations for IP address types](#http-ip-address-type-considerations)[Change the IP address type of a custom domain name](#http-api-custom-domain-names-ip-address-type-change)
