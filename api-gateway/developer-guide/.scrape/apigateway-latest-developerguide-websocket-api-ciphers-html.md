---
url: https://docs.aws.amazon.com/apigateway/latest/developerguide/websocket-api-ciphers.html
...
Security policy for WebSocket APIs in API Gateway - Amazon API Gateway
Security policy for WebSocket APIs in API Gateway - Amazon API Gateway
[](https://docs.aws.amazon.com/pdfs/apigateway/latest/developerguide/apigateway-dg.pdf#websocket-api-ciphers)
[Supported TLS protocols and ciphers for WebSocket APIs](#websocket-api-custom-domain-ciphers-list)[OpenSSL and
RFC cipher names](#apigateway-secure-connections-openssl-rfc-cipher-names-websocket)[Information about REST APIs and HTTP APIs](#apigateway-websocket-additional-apis)
# Security policy for WebSocket APIs in API Gateway
API Gateway enforces a security policy of `TLS\_1\_2` for all WebSocket API endpoints.
