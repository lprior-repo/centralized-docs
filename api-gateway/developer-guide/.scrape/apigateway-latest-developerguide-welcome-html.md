...
What is Amazon API Gateway? - Amazon API Gateway
[](https://docs.aws.amazon.com/pdfs/apigateway/latest/developerguide/apigateway-dg.pdf#welcome)
...
infrastructure](#api-gateway-overview-a-serverless-pillar)[How to get started with Amazon API Gateway](#welcome-how-to-get-started)
...
APIs](./api-gateway-overview-developer-experience.html#api-gateway-overview-websocket) and [Overview of WebSocket APIs in API Gateway](./apigateway-websocket-api-overview.html).
###### Topics
...
infrastructure](#api-gateway-overview-a-serverless-pillar)
...
with CloudWatch metrics](./apigateway-websocket-api-logging.html).
