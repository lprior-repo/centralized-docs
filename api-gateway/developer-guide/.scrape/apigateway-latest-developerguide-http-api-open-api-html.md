---
url: https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-open-api.html
title: Use OpenAPI definitions for
word_count: 947
filtered: true
elements_removed: 0
density_score: 0.68
...
Use OpenAPI definitions for HTTP APIs in API Gateway - Amazon API Gateway
[](https://docs.aws.amazon.com/pdfs/apigateway/latest/developerguide/apigateway-dg.pdf#http-api-open-api)
[Importing an HTTP API](#http-api-import)
...
OpenAPI, see [OpenAPI extensions for API Gateway](./api-gateway-swagger-extensions.html).
...
about exporting a REST API, see [Export a REST API from API Gateway](./api-gateway-export-api.html).
###### Note
...
The following
[import-api](https://docs.aws.amazon.com/cli/latest/reference/apigatewayv2/import-api.html) command imports the OpenAPI 3.0 definition file `api-definition.json` as an HTTP API:
```
