---
url: https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-integration-settings.html
title: Integrations for REST APIs
word_count: 503
filtered: true
elements_removed: 0
density_score: 0.84
...
Integrations for REST APIs in API Gateway - Amazon API Gateway
Integrations for REST APIs in API Gateway - Amazon API Gateway
[](https://docs.aws.amazon.com/pdfs/apigateway/latest/developerguide/apigateway-dg.pdf#how-to-integration-settings)
...
Programmatically, an integration request is encapsulated by the [`Integration`](https://docs.aws.amazon.com/apigateway/latest/api/API_Integration.html) resource and
an integration response by the [`IntegrationResponse`](https://docs.aws.amazon.com/apigateway/latest/api/API_IntegrationResponse.html) resource of API Gateway.
To set up an integration request, you create an [`Integration`](https://docs.aws.amazon.com/apigateway/latest/api/API_Integration.html) resource and
...
create an [`IntegrationResponse`](https://docs.aws.amazon.com/apigateway/latest/api/API_IntegrationResponse.html) resource and use it to set its target
method response. You then configure how to map backend output to the method response.
###### Topics
* [Set up an
integration request in API Gateway](./api-gateway-integration-settings-integration-request.html)
* [Set up an
integration response in API Gateway](./api-gateway-integration-settings-integration-response.html)
* [Lambda integrations for REST APIs in API Gateway](./set-up-lambda-integrations.html)
* [HTTP integrations for REST APIs in API Gateway](./setup-http-integrations.html)
* [Stream the integration response for your proxy integrations in API Gateway](./response-transfer-mode.html)
* [Private integrations for REST APIs in API Gateway](./private-integration.html)
* [Mock integrations for REST APIs in API Gateway](./how-to-mock-integration.html)
