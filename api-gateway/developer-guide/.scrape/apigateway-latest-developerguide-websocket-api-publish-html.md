---
url: https://docs.aws.amazon.com/apigateway/latest/developerguide/websocket-api-publish.html
title: Publish WebSocket APIs for customers to invoke
word_count: 322
filtered: true
elements_removed: 0
density_score: 0.87
...
Publish WebSocket APIs for customers to invoke - Amazon API Gateway
Publish WebSocket APIs for customers to invoke - Amazon API Gateway
[](https://docs.aws.amazon.com/pdfs/apigateway/latest/developerguide/apigateway-dg.pdf#websocket-api-publish)
...
###### Topics
* [Create stages for WebSocket APIs in API Gateway](./websocket-api-stages.html)
* [Deploy WebSocket APIs in
API Gateway](./apigateway-set-up-websocket-deployment.html)
* [Security policy for WebSocket APIs in API Gateway](./websocket-api-ciphers.html)
* [Custom domain names for WebSocket APIs in API Gateway](./websocket-api-custom-domain-names.html)
