...
chunk_id: ref/docs-reference-kubernetes-api-cluster-resources-api-service-v1.md/docs-reference-kubernetes-api-cluster-resources-api-service-v1#6-standard
chunk_level: standard
chunk_type: prose
heading: APIServiceList
token_count: 440
summary: #### Parameters * **name** (*in path*): string, required name of the APIService * **pretty** (*in query*): string...
---
