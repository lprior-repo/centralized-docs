...
chunk_id: ref/docs-reference-kubernetes-api-config-and-storage-resources-storage-class-v1.md/docs-reference-kubernetes-api-config-and-storage-resources-storage-class-v1#6-standard
chunk_level: standard
chunk_type: prose
heading: StorageClass
token_count: 510
summary: #### Parameters * **body**: [StorageClass](https://kubernetes.io/docs/reference/kubernetes-api/config-and-storage-resources/storage-class-v1/#StorageClass), required * **dryRun** (*in query*): string...
---
