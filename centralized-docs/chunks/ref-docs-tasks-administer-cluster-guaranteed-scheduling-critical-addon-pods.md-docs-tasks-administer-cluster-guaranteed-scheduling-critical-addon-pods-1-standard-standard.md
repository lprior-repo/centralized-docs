...
chunk_id: ref/docs-tasks-administer-cluster-guaranteed-scheduling-critical-addon-pods.md/docs-tasks-administer-cluster-guaranteed-scheduling-critical-addon-pods#1-standard
chunk_level: standard
chunk_type: prose
heading: Feedback
token_count: 445
summary: # Guaranteed Scheduling For Critical Add-On Pods Kubernetes core components such as the API server, scheduler, and controller-manager run on a control plane node. However, add-ons must run on a...
---
