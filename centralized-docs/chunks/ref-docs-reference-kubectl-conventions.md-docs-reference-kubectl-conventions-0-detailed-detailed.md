...
chunk_id: ref/docs-reference-kubectl-conventions.md/docs-reference-kubectl-conventions#0-detailed
chunk_level: detailed
chunk_type: prose
heading: Related Pages
token_count: 846
summary: ## Table of Contents    - [Using `kubectl` in Reusable Scripts](#using-kubectl-in-reusable-scripts)     - [`kubectl run`](#kubectl-run)     - [`kubectl apply`](#kubectl-apply)   -...
---
