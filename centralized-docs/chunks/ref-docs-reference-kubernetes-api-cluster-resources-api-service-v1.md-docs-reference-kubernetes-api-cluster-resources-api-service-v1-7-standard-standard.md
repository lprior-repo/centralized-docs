...
chunk_id: ref/docs-reference-kubernetes-api-cluster-resources-api-service-v1.md/docs-reference-kubernetes-api-cluster-resources-api-service-v1#7-standard
chunk_level: standard
chunk_type: prose
heading: APIServiceList
token_count: 503
summary: #### Parameters * **body**: [APIService](https://kubernetes.io/docs/reference/kubernetes-api/cluster-resources/api-service-v1/#APIService), required * **dryRun** (*in query*): string...
---
