...
chunk_id: ref/docs-reference-kubernetes-api-config-and-storage-resources-secret-v1.md/docs-reference-kubernetes-api-config-and-storage-resources-secret-v1#7-standard
chunk_level: standard
chunk_type: prose
heading: SecretList
token_count: 388
summary: #### Response 200 ([Secret](https://kubernetes.io/docs/reference/kubernetes-api/config-and-storage-resources/secret-v1/#Secret)): OK 201...
---
