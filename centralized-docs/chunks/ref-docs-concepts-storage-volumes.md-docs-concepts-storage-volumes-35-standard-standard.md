...
chunk_id: ref/docs-concepts-storage-volumes.md/docs-concepts-storage-volumes#35-standard
chunk_level: standard
chunk_type: prose
heading: Read-only mounts
token_count: 505
summary: a Pod that needs to mount something on the host using a `hostPath` volume. This mode is equal to `rshared` mount propagation as described in the...
---
