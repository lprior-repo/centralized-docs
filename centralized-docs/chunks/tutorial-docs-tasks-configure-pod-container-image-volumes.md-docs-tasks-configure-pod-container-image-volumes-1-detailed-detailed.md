...
chunk_id: tutorial/docs-tasks-configure-pod-container-image-volumes.md/docs-tasks-configure-pod-container-image-volumes#1-detailed
chunk_level: detailed
chunk_type: code
heading: Use `subPath` (or `subPathExpr`)
token_count: 934
summary: # Use an Image Volume With a Pod FEATURE STATE: `Kubernetes v1.35 [beta]`(enabled by default) This page shows how to configure a pod using image volumes. This allows you to mount content from OCI...
---
