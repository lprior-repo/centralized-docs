...
chunk_id: ref/docs-concepts-storage-volumes.md/docs-concepts-storage-volumes#16-standard
chunk_level: standard
chunk_type: prose
heading: Types of volumes
token_count: 397
summary: # The mount into the container is read-only. apiVersion: v1 kind: Pod metadata: name: hostpath-example-windows spec: os: { name: windows } nodeSelector: kubernetes.io/os: windows containers: - name:...
---
