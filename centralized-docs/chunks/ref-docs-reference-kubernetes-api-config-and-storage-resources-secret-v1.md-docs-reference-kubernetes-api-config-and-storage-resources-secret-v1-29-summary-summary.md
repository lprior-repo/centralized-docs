...
chunk_id: ref/docs-reference-kubernetes-api-config-and-storage-resources-secret-v1.md/docs-reference-kubernetes-api-config-and-storage-resources-secret-v1#29-summary
chunk_level: summary
chunk_type: prose
heading: SecretList
token_count: 116
summary: * **name** (*in path*): string, required name of the Secret * **namespace** (*in path*): string, required...
---
