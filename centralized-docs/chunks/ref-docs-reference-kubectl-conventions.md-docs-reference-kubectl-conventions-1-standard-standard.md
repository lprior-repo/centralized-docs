...
chunk_id: ref/docs-reference-kubectl-conventions.md/docs-reference-kubectl-conventions#1-standard
chunk_level: standard
chunk_type: prose
heading: Using `kubectl` in Reusable Scripts
token_count: 494
summary: ## Using `kubectl` in Reusable Scripts For a stable output in a script: * Request one of the machine-oriented output forms, such as `-o name`, `-o json`, `-o yaml`, `-o go-template`, or `-o...
---
