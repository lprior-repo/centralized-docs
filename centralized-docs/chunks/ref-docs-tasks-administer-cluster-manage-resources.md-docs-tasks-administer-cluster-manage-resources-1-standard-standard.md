...
chunk_id: ref/docs-tasks-administer-cluster-manage-resources.md/docs-tasks-administer-cluster-manage-resources#1-standard
chunk_level: standard
chunk_type: prose
heading: Related Pages
token_count: 477
summary: ##### [Configure Minimum and Maximum Memory Constraints for a Namespace](/docs/tasks/administer-cluster/manage-resources/memory-constraint-namespace/) Define a range of valid memory resource limits...
---
