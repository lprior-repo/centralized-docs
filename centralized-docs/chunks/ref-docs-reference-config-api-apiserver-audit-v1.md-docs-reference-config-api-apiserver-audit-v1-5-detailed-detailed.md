...
chunk_id: ref/docs-reference-config-api-apiserver-audit-v1.md/docs-reference-config-api-apiserver-audit-v1#5-detailed
chunk_level: detailed
chunk_type: prose
heading: Related Pages
token_count: 412
summary: ## `Stage` (Alias of `string`) **Appears in:** * [Event](#audit-k8s-io-v1-Event) * [Policy](#audit-k8s-io-v1-Policy) * [PolicyRule](#audit-k8s-io-v1-PolicyRule) Stage defines the stages in request...
---
...
- [apiserver admission.v1](docs-reference-config-api-apiserver-admission-v1.md)
