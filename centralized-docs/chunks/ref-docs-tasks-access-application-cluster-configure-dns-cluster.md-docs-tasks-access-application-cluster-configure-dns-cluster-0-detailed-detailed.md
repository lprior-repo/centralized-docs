---
doc_id: ref/docs-tasks-access-application-cluster-configure-dns-cluster.md/docs-tasks-access-application-cluster-configure-dns-cluster
chunk_id: ref/docs-tasks-access-application-cluster-configure-dns-cluster.md/docs-tasks-access-application-cluster-configure-dns-cluster#0-detailed
chunk_level: detailed
chunk_type: prose
heading: Related Pages
token_count: 404
summary: ## Table of Contents  - [Configure DNS for a Cluster](#configure-dns-for-a-cluster)   - [Feedback](#feedback)  ---  # Configure DNS for a Cluster Kubernetes offers a DNS cluster addon, which most of...
---

## Table of Contents

- [Configure DNS for a Cluster](#configure-dns-for-a-cluster)
  - [Feedback](#feedback)
