...
chunk_id: concept/docs-tasks-tools-install-kubectl-linux.md/docs-tasks-tools-install-kubectl-linux#13-standard
chunk_level: standard
chunk_type: prose
heading: Related Pages
token_count: 99
summary: ## Related Pages  - [install kubectl macos](docs-tasks-tools-install-kubectl-macos.md) - [Access Applications in a Cluster](docs-tasks-access-application-cluster.md) - [Monitoring, Logging, and...
---
