...
chunk_id: ref/docs-reference-kubernetes-api-authorization-resources-local-subject-access-review-v1.md/docs-reference-kubernetes-api-authorization-resources-local-subject-access-review-v1#7-summary
chunk_level: summary
chunk_type: prose
heading: LocalSubjectAccessReview
token_count: 100
summary: * **fieldManager** (*in query*): string [fieldManager](https://kubernetes.io/docs/reference/kubernetes-api/common-parameters/common-parameters/#fieldManager) * **fieldValidation** (*in query*):...
---
