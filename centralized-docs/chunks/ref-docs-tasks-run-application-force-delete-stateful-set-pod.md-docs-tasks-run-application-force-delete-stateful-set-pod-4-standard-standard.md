...
chunk_id: ref/docs-tasks-run-application-force-delete-stateful-set-pod.md/docs-tasks-run-application-force-delete-stateful-set-pod#4-standard
...
- [Scale a StatefulSet](docs-tasks-run-application-scale-stateful-set.md)
