...
chunk_id: ref/docs-reference-instrumentation-slis.md/docs-reference-instrumentation-slis#5-summary
chunk_level: summary
chunk_type: prose
heading: SLI Metrics
token_count: 127
summary: kubernetes\_healthcheck{name=\"etcd\",type=\"readyz\"} 1 kubernetes\_healthcheck{name=\"etcd-readiness\",type=\"readyz\"} 1 kubernetes\_healthcheck{name=\"informer-sync\",type=\"readyz\"} 1...
---
