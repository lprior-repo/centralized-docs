...
chunk_id: concept/docs-tasks-tools-install-kubectl-linux.md/docs-tasks-tools-install-kubectl-linux#6-standard
chunk_level: standard
chunk_type: prose
heading: Install kubectl on Linux
token_count: 134
summary: ### Install using other package management If you are on Ubuntu or another Linux distribution that supports the [snap](https://snapcraft.io/docs/core/install) package manager, kubectl is available as...
---
