...
chunk_id: tutorial/docs-tutorials-security-apparmor.md/docs-tutorials-security-apparmor#27-summary
chunk_level: summary
chunk_type: prose
heading: Example
token_count: 124
summary: Kubernetes 1.35 does not provide any built-in mechanisms for loading AppArmor profiles onto Nodes. Profiles can be loaded through custom infrastructure or tools like the [Kubernetes Security Profiles...
---
