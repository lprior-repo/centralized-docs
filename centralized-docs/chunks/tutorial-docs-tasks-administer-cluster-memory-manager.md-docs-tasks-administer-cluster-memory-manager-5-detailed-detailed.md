...
chunk_id: tutorial/docs-tasks-administer-cluster-memory-manager.md/docs-tasks-administer-cluster-memory-manager#5-detailed
...
- [kube scheduler](docs-reference-command-line-tools-reference-kube-scheduler.md)
