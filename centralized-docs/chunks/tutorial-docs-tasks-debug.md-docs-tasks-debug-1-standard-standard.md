...
chunk_id: tutorial/docs-tasks-debug.md/docs-tasks-debug#1-standard
chunk_level: standard
chunk_type: prose
heading: Getting help
token_count: 389
summary: # Monitoring, Logging, and Debugging Set up monitoring and logging to troubleshoot a cluster, or debug a containerized application. Sometimes things go wrong. This guide helps you gather the relevant...
---
