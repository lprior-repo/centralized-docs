...
chunk_id: ref/docs-tasks-administer-cluster-migrating-from-dockershim-check-if-dockershim-removal-affects-you.md/docs-tasks-administer-cluster-migrating-from-dockershim-check-if-dockershim-removal-affects-you#23-summary
chunk_level: summary
chunk_type: prose
heading: Related Pages
token_count: 102
summary: ## Related Pages  - [Communication between Nodes and the Control Plane](docs-concepts-architecture-control-plane-node-communication.md) - [Kubernetes...
---
