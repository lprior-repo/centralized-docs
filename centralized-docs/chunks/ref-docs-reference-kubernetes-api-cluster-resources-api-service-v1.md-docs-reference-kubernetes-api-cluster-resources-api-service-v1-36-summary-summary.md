...
chunk_id: ref/docs-reference-kubernetes-api-cluster-resources-api-service-v1.md/docs-reference-kubernetes-api-cluster-resources-api-service-v1#36-summary
chunk_level: summary
chunk_type: prose
heading: APIServiceList
token_count: 118
summary: * **name** (*in path*): string, required name of the APIService * **body**: [APIService](https://kubernetes.io/docs/reference/kubernetes-api/cluster-resources/api-service-v1/#APIService), required *...
---
