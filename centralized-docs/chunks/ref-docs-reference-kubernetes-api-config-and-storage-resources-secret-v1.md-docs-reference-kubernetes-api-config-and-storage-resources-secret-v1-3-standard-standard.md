...
chunk_id: ref/docs-reference-kubernetes-api-config-and-storage-resources-secret-v1.md/docs-reference-kubernetes-api-config-and-storage-resources-secret-v1#3-standard
chunk_level: standard
chunk_type: prose
heading: SecretList
token_count: 507
summary: #### Parameters * **name** (*in path*): string, required name of the Secret * **namespace** (*in path*): string, required...
---
