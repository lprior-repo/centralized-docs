...
chunk_id: ref/docs-concepts-workloads-controllers-ttlafterfinished.md/docs-concepts-workloads-controllers-ttlafterfinished#4-standard
chunk_level: standard
chunk_type: prose
heading: Related Pages
token_count: 101
summary: ## Related Pages  - [Objects In Kubernetes](docs-concepts-overview-working-with-objects.md) - [Using RBAC Authorization](docs-reference-access-authn-authz-rbac.md) - [Certificates and Certificate...
---
