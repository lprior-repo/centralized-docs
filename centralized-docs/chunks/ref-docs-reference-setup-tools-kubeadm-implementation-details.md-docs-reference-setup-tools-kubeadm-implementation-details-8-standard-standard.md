...
chunk_id: ref/docs-reference-setup-tools-kubeadm-implementation-details.md/docs-reference-setup-tools-kubeadm-implementation-details#8-standard
chunk_level: standard
chunk_type: prose
heading: kubeadm init workflow internal design
token_count: 156
summary: * [Error] if etcd certificates or keys are specified, but not provided * If external etcd is NOT provided (and thus local etcd will be installed): * [Error] if ports 2379 is used * [Error] if...
---
