...
chunk_id: ref/docs-reference-kubernetes-api-cluster-resources-api-service-v1.md/docs-reference-kubernetes-api-cluster-resources-api-service-v1#42-summary
chunk_level: summary
chunk_type: prose
heading: APIServiceList
token_count: 114
summary: * **name** (*in path*): string, required name of the APIService * **body**: [Patch](https://kubernetes.io/docs/reference/kubernetes-api/common-definitions/patch/#Patch), required * **dryRun** (*in...
---
