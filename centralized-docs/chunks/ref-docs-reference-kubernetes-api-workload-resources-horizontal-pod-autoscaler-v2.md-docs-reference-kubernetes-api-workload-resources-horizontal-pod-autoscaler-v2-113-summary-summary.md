...
chunk_id: ref/docs-reference-kubernetes-api-workload-resources-horizontal-pod-autoscaler-v2.md/docs-reference-kubernetes-api-workload-resources-horizontal-pod-autoscaler-v2#113-summary
chunk_level: summary
chunk_type: prose
heading: HorizontalPodAutoscalerList
token_count: 96
summary: * **name** (*in path*): string, required name of the HorizontalPodAutoscaler * **namespace** (*in path*): string, required...
---
