...
chunk_id: ref/docs-reference-kubectl-generated-kubectluncordon.md/docs-reference-kubectl-generated-kubectluncordon#1-detailed
chunk_level: detailed
chunk_type: table
heading: Parent Options Inherited
token_count: 991
summary: ## Synopsis Mark node as schedulable. ``` `kubectl uncordon NODE ` ``` ## Examples ``` ` # Mark node \"foo\" as schedulable kubectl uncordon foo ` ``` ## Options |--dry-run string[=\"unchanged\"]Default:...
---
