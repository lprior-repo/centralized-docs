...
chunk_id: tutorial/docs-reference-access-authn-authz-service-accounts-admin.md/docs-reference-access-authn-authz-service-accounts-admin#9-standard
chunk_level: standard
chunk_type: prose
heading: Manual Secret management for ServiceAccounts
token_count: 306
summary: #### Note: There is no specific mechanism to invalidate a token issued via TokenRequest. If you no longer trust a bound service account token for a Pod, you can delete that Pod. Deleting a Pod...
---
