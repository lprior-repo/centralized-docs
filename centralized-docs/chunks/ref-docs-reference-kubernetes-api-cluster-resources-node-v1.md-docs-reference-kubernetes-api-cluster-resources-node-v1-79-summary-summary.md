...
chunk_id: ref/docs-reference-kubernetes-api-cluster-resources-node-v1.md/docs-reference-kubernetes-api-cluster-resources-node-v1#79-summary
chunk_level: summary
chunk_type: prose
heading: NodeList
token_count: 113
summary: * **name** (*in path*): string, required name of the Node * **body**: [Patch](https://kubernetes.io/docs/reference/kubernetes-api/common-definitions/patch/#Patch), required * **dryRun** (*in query*):...
---
