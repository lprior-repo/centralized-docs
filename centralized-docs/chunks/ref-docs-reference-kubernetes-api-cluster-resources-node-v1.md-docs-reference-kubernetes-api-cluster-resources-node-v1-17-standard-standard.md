...
chunk_id: ref/docs-reference-kubernetes-api-cluster-resources-node-v1.md/docs-reference-kubernetes-api-cluster-resources-node-v1#17-standard
chunk_level: standard
chunk_type: prose
heading: NodeList
token_count: 481
summary: #### Parameters * **body**: [Node](https://kubernetes.io/docs/reference/kubernetes-api/cluster-resources/node-v1/#Node), required * **dryRun** (*in query*): string...
---
