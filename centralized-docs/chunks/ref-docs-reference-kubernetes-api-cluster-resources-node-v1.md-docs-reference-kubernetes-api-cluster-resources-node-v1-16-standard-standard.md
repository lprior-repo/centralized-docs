...
chunk_id: ref/docs-reference-kubernetes-api-cluster-resources-node-v1.md/docs-reference-kubernetes-api-cluster-resources-node-v1#16-standard
chunk_level: standard
chunk_type: prose
heading: NodeList
token_count: 439
summary: #### Parameters * **name** (*in path*): string, required name of the Node * **pretty** (*in query*): string...
---
