...
chunk_id: ref/docs-concepts-overview-working-with-objects-annotations.md/docs-concepts-overview-working-with-objects-annotations#2-detailed
chunk_level: detailed
chunk_type: prose
heading: Related Pages
token_count: 354
summary: ## What's next * Learn more about [Labels and Selectors](/docs/concepts/overview/working-with-objects/labels/). * Find [Well-known labels, Annotations and...
---
