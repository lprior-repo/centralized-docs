---
id: ops/docs-contribute-advanced.md/docs-contribute-advanced
title: Advanced contributing
category: ops
tags: ["advanced", "contents", "contributing", "improvements", "ops"]
---
...
* [Advanced contributing](#advanced-contributing)
  ...
  * [Serve as a SIG Co-chair](#serve-as-a-sig-co-chair)
...
# Advanced contributing
 ...
 > 
 > **Context**: This page assumes that you understand how to contribute to new content  and review others' work , and are ready to learn about more ways to contribute
...
* Commit at least 5 hours per week (and often more) to the role for a minimum of 6 months### Responsibilities
...
* Recruit for and advocate on behalf of SIG Docs with the [CNCF](https://cncf.io/) and its platinum partners, including Google, Oracle, Azure, IBM, and Huawei
* Keep the SIG running smoothly### Running effective meetings
...
* Claim the host role when you log in by entering the host key![Claiming the host role in Zoom](/images/docs/contribute/claim-host.png)\### Recording meetings on Zoom
...
Last modified January 09, 2023 at 11:42 PM PST: [Jim Angel going to emeritus (5b44de3dd1)](https://github.com/kubernetes/website/commit/5b44de3dd1d432b2c4059b62a2176069dcaee6fb)
