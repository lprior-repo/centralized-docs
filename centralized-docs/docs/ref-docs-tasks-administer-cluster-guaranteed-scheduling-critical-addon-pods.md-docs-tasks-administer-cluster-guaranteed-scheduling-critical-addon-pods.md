---
id: ref/docs-tasks-administer-cluster-guaranteed-scheduling-critical-addon-pods.md/docs-tasks-administer-cluster-guaranteed-scheduling-critical-addon-pods
title: Guaranteed Scheduling For Critical Add-On Pods
category: ref
tags: ["add-on", "contents", "critical", "guaranteed", "marking"]
---
...
# Guaranteed Scheduling For Critical Add-On Pods
 ...
 > 
 > **Context**: Kubernetes core components such as the API server, scheduler, and controller-manager run on a control plane node. However, add-ons must run on a regul
