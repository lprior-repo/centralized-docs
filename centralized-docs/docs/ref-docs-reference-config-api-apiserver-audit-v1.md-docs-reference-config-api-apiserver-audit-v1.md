---
id: ref/docs-reference-config-api-apiserver-audit-v1.md/docs-reference-config-api-apiserver-audit-v1
title: Docs Reference Config Api Apiserver Audit V1
category: ref
tags: ["contents", "eventlist", "ref", "resource", "table"]
---

# Docs Reference Config Api Apiserver Audit V1



 > 
 > **Context**: EventList is a list of audit Events. |Field|Description| | apiVersion string| audit.k8s.io/v1 | | kind string| EventList | | metadata meta/v1.ListMeta
...
1. X-Real-Ip header, if not present in the X-Forwarded-For list
1. The remote address for the connection, if it doesn’t match the last
...
* [apiserver admission.v1](./ref-docs-reference-config-api-apiserver-admission-v1.md-docs-reference-config-api-apiserver-admission-v1.md)
