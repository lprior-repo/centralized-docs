---
id: ref/docs-reference-setup-tools-kubeadm.md/docs-reference-setup-tools-kubeadm
title: Kubeadm
category: ref
tags: ["contents", "install", "kubeadm", "ref", "table"]
---
...
# Kubeadm
 ...
 > 
 > **Context**: Kubeadm is a tool built to provide  kubeadm init  and  kubeadm join  as best-practice "fast paths" for creating Kubernetes clusters. kubeadm performs 
