---
id: ref/docs-contribute.md/docs-contribute
title: Contribute to Kubernetes
category: ref
tags: ["contents", "contribute", "feedback", "kubernetes", "ref"]
---
...
# Contribute to Kubernetes
 ...
 > 
 > **Context**: There are lots of ways to contribute to Kubernetes. You can work on designs for new features, you can document the code we already have, you can  writ
...
a dedicated website: [https://k8s.dev/](https://k8s.dev/). You can go there to learn more about
...
Last modified March 13, 2025 at 10:41 AM PST: [Add guide to blog contributions (815a75d025)](https://github.com/kubernetes/website/commit/815a75d02530dc7049160a8806b68781b958ca62)
