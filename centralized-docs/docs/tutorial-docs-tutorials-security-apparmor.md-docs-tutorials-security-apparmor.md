---
id: tutorial/docs-tutorials-security-apparmor.md/docs-tutorials-security-apparmor
title: Restrict a Container's Access to Resources with AppArmor
category: tutorial
tags: ["access", "apparmor", "container's", "contents", "objectives"]
---
...
# Restrict a Container’s Access to Resources with AppArmor
 ...
 > 
 > **Context**: Restrict a Container's Access to Resources with AppArmor | Kubernetes
