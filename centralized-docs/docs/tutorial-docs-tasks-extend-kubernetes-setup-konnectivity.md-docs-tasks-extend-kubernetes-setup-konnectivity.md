---
id: tutorial/docs-tasks-extend-kubernetes-setup-konnectivity.md/docs-tasks-extend-kubernetes-setup-konnectivity
title: Set up Konnectivity service
category: tutorial
tags: ["before", "begin", "contents", "konnectivity", "service"]
---
...
# Set up Konnectivity service
 ...
 > 
 > **Context**: The Konnectivity service provides a TCP level proxy for the control plane to cluster communication.
