---
id: ref/docs-reference-access-authn-authz-certificate-signing-requests.md/docs-reference-access-authn-authz-certificate-signing-requests
title: Certificates and Certificate Signing Requests
category: ref
tags: ["certificate", "certificates", "contents", "ref", "requests"]
---
...
# Certificates and Certificate Signing Requests
 ...
 > 
 > **Context**: Kubernetes certificate and trust bundle APIs enable automation of X.509  credential provisioning by providing a programmatic interface for clients of 
...
1. Permitted subjects - organizations are exactly `["system:nodes"]`, common name is “`system:node:${NODE\_NAME}`”.
...
* [Use an Image Volume With a Pod](./tutorial-docs-tasks-configure-pod-container-image-volumes.md-docs-tasks-configure-pod-container-image-volumes.md)
