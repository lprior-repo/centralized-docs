---
id: ref/docs-contribute-style-style-guide.md/docs-contribute-style-style-guide
title: Documentation Style Guide
category: ref
tags: ["contents", "documentation", "note:", "ref", "style"]
---
...
* [Documentation Style Guide](#documentation-style-guide)
  * [Note:](#note)
  * [Language](#language)
    * [Use upper camel case for API objects](#use-upper-camel-case-for-api-objects)
    ...
    * [Use code style for inline code, commands](#use-code-style-for-inline-code-commands)
      * [Note:](#note)
    * [Use code style for object field names and namespaces](#use-code-style-for-object-field-names-and-namespaces)
    * [Use code style for Kubernetes command tool and component names](#use-code-style-for-kubernetes-command-tool-and-component-names)
    * [Starting a sentence with a component tool or component name](#starting-a-sentence-with-a-component-tool-or-component-name)
    * [Use a general descriptor over a component name](#use-a-general-descriptor-over-a-component-name)
    * [Use normal style for string and integer field values](#use-normal-style-for-string-and-integer-field-values)
  * [Referring to Kubernetes API resources](#referring-to-kubernetes-api-resources)
    * [Clarification about “resource”](#clarification-about-resource)
    * [When to use Kubernetes API terminologies](#when-to-use-kubernetes-api-terminologies)
    * [API resource names](#api-resource-names)
  ...
  * [Kubernetes.io word list](#kubernetesio-word-list)
  * [Shortcodes](#shortcodes)
    ...
    * [Avoid words that assume a specific level of understanding](#avoid-words-that-assume-a-specific-level-of-understanding)
...
# Documentation Style Guide
 ...
 > 
 > **Context**: This page gives writing style guidelines for the Kubernetes documentation. These are guidelines, not rules. Use your best judgment, and feel free to p
...
document, use the backtick (``). However, API kinds such as StatefulSet or ConfigMap are written verbatim (no backticks); this allows using possessive apostrophes. Do and Don't - Use code style for inline code, commands, and API objects|Do|Don't| |The `kubectl run` command creates a Pod.|The "kubectl run" command creates a Pod.| |The kubelet on each node acquires a Lease…|The kubelet on each node acquires a `Lease`…| |A PersistentVolume represents durable storage…|A `PersistentVolume` represents durable storage…| |The CustomResourceDefinition's `.spec.group` field…|The `CustomResourceDefinition.spec.group` field…| |For declarative management, use `kubectl apply`.|For declarative management, use "kubectl apply".| |Enclose code samples with triple backticks. (``)|Enclose code samples with any other syntax.|
...
1. Use the following syntax to apply a style:
...
* [Advanced contributing](./ops-docs-contribute-advanced.md-docs-contribute-advanced.md)
* [Tutorials](./tutorial-docs-tutorials.md-docs-tutorials.md)
