---
id: ref/docs-concepts-storage-volumes.md/docs-concepts-storage-volumes
title: Volumes
category: ref
tags: ["contents", "important", "ref", "table", "volumes"]
---
...
# Volumes
 ...
 > 
 > **Context**: Kubernetes  volumes  provide a way for containers in a  Pod to access and share data via the filesystem. There are different kinds of volume that you 
