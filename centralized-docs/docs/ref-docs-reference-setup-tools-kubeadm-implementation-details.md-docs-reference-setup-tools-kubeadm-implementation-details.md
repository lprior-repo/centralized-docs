---
id: ref/docs-reference-setup-tools-kubeadm-implementation-details.md/docs-reference-setup-tools-kubeadm-implementation-details
title: Implementation details
category: ref
tags: ["contents", "design", "details", "implementation", "principles"]
---
...
# Implementation details
 ...
 > 
 > **Context**: FEATURE STATE: Kubernetes v1.10 [stable] kubeadm init  and  kubeadm join  together provide a nice user experience for creating a bare Kubernetes clust
...
* [Upgrading kubeadm clusters](./ref-docs-tasks-administer-cluster-kubeadm-kubeadm-upgrade.md-docs-tasks-administer-cluster-kubeadm-kubeadm-upgrade.md)
* [Authenticating with Bootstrap Tokens](./ref-docs-reference-access-authn-authz-bootstrap-tokens.md-docs-reference-access-authn-authz-bootstrap-tokens.md)
