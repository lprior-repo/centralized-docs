---
id: ref/docs-tasks-administer-cluster-kubeadm-kubeadm-upgrade.md/docs-tasks-administer-cluster-kubeadm-kubeadm-upgrade
title: Upgrading kubeadm clusters
category: ref
tags: ["changing", "clusters", "contents", "kubeadm", "package"]
---
...
# Upgrading kubeadm clusters
 ...
 > 
 > **Context**: This page explains how to upgrade a Kubernetes cluster created with kubeadm from version 1.34.x to version 1.35.x, and from version 1.35.x to 1.35.y (
...
1. Upgrade worker nodes.## Before you begin
