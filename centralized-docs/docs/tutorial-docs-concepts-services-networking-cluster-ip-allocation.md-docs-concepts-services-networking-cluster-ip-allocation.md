---
id: tutorial/docs-concepts-services-networking-cluster-ip-allocation.md/docs-concepts-services-networking-cluster-ip-allocation
title: Service ClusterIP allocation
category: tutorial
tags: ["allocated?", "allocation", "clusterip", "clusterips", "contents"]
---
...
* [Service ClusterIP allocation](#service-clusterip-allocation)
  ...
  * [Why do you need to reserve Service Cluster IPs?](#why-do-you-need-to-reserve-service-cluster-ips)
...
# Service ClusterIP allocation
 ...
 > 
 > **Context**: In Kubernetes,  Services  are an abstract way to expose an application running on a set of Pods. Services can have a cluster-scoped virtual IP address
...
* [Service](./ref-docs-reference-kubernetes-api-service-resources-service-v1.md-docs-reference-kubernetes-api-service-resources-service-v1.md)
