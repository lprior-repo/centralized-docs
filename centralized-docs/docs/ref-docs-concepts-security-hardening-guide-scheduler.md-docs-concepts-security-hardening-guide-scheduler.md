---
id: ref/docs-concepts-security-hardening-guide-scheduler.md/docs-concepts-security-hardening-guide-scheduler
title: Hardening Guide - Scheduler Configuration
category: ref
tags: ["authentication", "authorization", "command", "configuration", "contents"]
---
...
# Hardening Guide - Scheduler Configuration
 ...
 > 
 > **Context**: Information about how to make the Kubernetes scheduler more secure. The Kubernetes  scheduler  is one of the critical components of the control plane 
