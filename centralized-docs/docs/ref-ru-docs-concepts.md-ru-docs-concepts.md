---
id: ref/ru-docs-concepts.md/ru-docs-concepts
title: Концепции
category: ref
tags: ["contents", "ref", "table", "концепции", "краткий"]
---
...
* [Концепции](#концепции)
  * [Краткий обзор](#краткий-обзор)
    ...
    * [Узлы Kubernetes](#узлы-kubernetes)
  * [Что дальше](#что-дальше)
    * \[[Рабочие нагрузки](/ru/docs/concepts/workloads/)\](#рабочие-нагрузкиrudocsconceptsworkloads)
    * \[[Планирование, приоритизация и вытеснение](/ru/docs/concepts/scheduling-eviction/)\](#планирование-приоритизация-и-вытеснениеrudocsconceptsscheduling-eviction)
    * \[[Администрирование кластера](/ru/docs/concepts/cluster-administration/)\](#администрирование-кластераrudocsconceptscluster-administration)
...
# Концепции
 ...
 > 
 > **Context**: Раздел "Концепции" поможет вам узнать о частях системы Kubernetes и об абстракциях, которые Kubernetes использует для представления вашего



Раздел “Концепции” поможет вам узнать о частях системы Kubernetes и об абстракциях, которые Kubernetes использует для представления вашего [кластера](/ru/docs/reference/glossary/?all=true#term-cluster), и помогает вам глубже понять, как работает Kubernetes.
...
* [Concepts](./ref-fr-docs-concepts.md-fr-docs-concepts.md)
* [Objects In Kubernetes](./ref-docs-concepts-overview-working-with-objects.md-docs-concepts-overview-working-with-objects.md)
* [Service ClusterIP allocation](./tutorial-docs-concepts-services-networking-cluster-ip-allocation.md-docs-concepts-services-networking-cluster-ip-allocation.md)
* [Managing Service Accounts](./tutorial-docs-reference-access-authn-authz-service-accounts-admin.md-docs-reference-access-authn-authz-service-accounts-admin.md)
