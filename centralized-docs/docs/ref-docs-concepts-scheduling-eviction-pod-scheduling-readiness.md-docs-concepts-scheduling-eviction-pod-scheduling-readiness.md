---
id: ref/docs-concepts-scheduling-eviction-pod-scheduling-readiness.md/docs-concepts-scheduling-eviction-pod-scheduling-readiness
title: Pod Scheduling Readiness
category: ref
tags: ["configuring", "contents", "readiness", "ref", "scheduling"]
---

## Table of Contents

* [Pod Scheduling Readiness](#pod-scheduling-readiness)
  * [Configuring Pod schedulingGates](#configuring-pod-schedulinggates)
  * [Usage example](#usage-example)
  * [Observability](#observability)
  * [Mutable Pod scheduling directives](#mutable-pod-scheduling-directives)
...
# Pod Scheduling Readiness
 ...
 > 
 > **Context**: FEATURE STATE: Kubernetes v1.30 [stable] Pods were considered ready for scheduling once created. Kubernetes scheduler does its due diligence to find n
...
1. For `spec.affinity.nodeAffinity`, if nil, then setting anything is allowed.
1. If `NodeSelectorTerms` was empty, it will be allowed to be set.
...
1. For `.preferredDuringSchedulingIgnoredDuringExecution`, all updates are allowed.
