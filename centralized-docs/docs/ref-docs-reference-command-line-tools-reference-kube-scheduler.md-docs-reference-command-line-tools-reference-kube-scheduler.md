---
id: ref/docs-reference-command-line-tools-reference-kube-scheduler.md/docs-reference-command-line-tools-reference-kube-scheduler
title: Docs Reference Command Line Tools Reference Kube Scheduler
category: ref
tags: ["contents", "options", "ref", "synopsis", "table"]
---
...
# Docs Reference Command Line Tools Reference Kube Scheduler
 ...
 > 
 > **Context**: The Kubernetes scheduler is a control plane process which assigns Pods to Nodes. The scheduler determines which Nodes are valid placements for each Po
...
* [Control Memory Management Policies on a Node](./tutorial-docs-tasks-administer-cluster-memory-manager.md-docs-tasks-administer-cluster-memory-manager.md)
