---
id: ref/docs-contribute-style-content-guide.md/docs-contribute-style-content-guide
title: Documentation Content Guide
category: ref
tags: ["content", "contents", "documentation", "overview", "ref"]
---

## Table of Contents

* [Documentation Content Guide](#documentation-content-guide)
  * [Overview](#overview)
  * [What’s allowed](#whats-allowed)
    * [Dual sourced content](#dual-sourced-content)
      * [Note:](#note)
...
# Documentation Content Guide
 ...
 > 
 > **Context**: This page contains guidelines for Kubernetes documentation. If you have questions about what's allowed, join the #sig-docs channel in Kubernetes Slack
...
You can register for Kubernetes Slack at [https://slack.k8s.io/](https://slack.k8s.io/).
...
* [Validate IPv4/IPv6 dual-stack](./ref-docs-tasks-network-validate-dual-stack.md-docs-tasks-network-validate-dual-stack.md)
