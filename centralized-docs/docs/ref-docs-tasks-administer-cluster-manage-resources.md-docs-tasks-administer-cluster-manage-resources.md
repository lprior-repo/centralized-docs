---
id: ref/docs-tasks-administer-cluster-manage-resources.md/docs-tasks-administer-cluster-manage-resources
title: Docs Tasks Administer Cluster Manage Resources
category: ref
tags: ["configure", "contents", "default", "limits", "memory"]
---
...
# Docs Tasks Administer Cluster Manage Resources
 ...
 > 
 > **Context**: Define a default memory resource limit for a namespace, so that every new Pod in that namespace has a memory resource limit configured.
