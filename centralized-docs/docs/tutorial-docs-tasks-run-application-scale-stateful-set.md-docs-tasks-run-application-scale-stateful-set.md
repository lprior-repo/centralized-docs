---
id: tutorial/docs-tasks-run-application-scale-stateful-set.md/docs-tasks-run-application-scale-stateful-set
title: Scale a StatefulSet
category: tutorial
tags: ["before", "begin", "contents", "scale", "statefulset"]
---
...
* [Scale a StatefulSet](#scale-a-statefulset)
  * [Before you begin](#before-you-begin)
    ...
    * [Make in-place updates on your StatefulSets](#make-in-place-updates-on-your-statefulsets)
    * [Scaling down does not work right](#scaling-down-does-not-work-right)
...
# Scale a StatefulSet
 ...
 > 
 > **Context**: This task shows how to scale a StatefulSet. Scaling a StatefulSet refers to increasing or decreasing the number of replicas.
...
* [Force Delete StatefulSet Pods](./ref-docs-tasks-run-application-force-delete-stateful-set-pod.md-docs-tasks-run-application-force-delete-stateful-set-pod.md)
