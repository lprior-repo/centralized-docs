---
id: ref/docs-concepts-workloads-controllers-ttlafterfinished.md/docs-concepts-workloads-controllers-ttlafterfinished
title: Automatic Cleanup for Finished Jobs
category: ref
tags: ["automatic", "cleanup", "contents", "finished", "ref"]
---

## Table of Contents

* [Automatic Cleanup for Finished Jobs](#automatic-cleanup-for-finished-jobs)
  * [Cleanup for finished Jobs](#cleanup-for-finished-jobs)
    * [Updating TTL for finished Jobs](#updating-ttl-for-finished-jobs)
    * [Time skew](#time-skew)
...
# Automatic Cleanup for Finished Jobs
 ...
 > 
 > **Context**: A time-to-live mechanism to clean up old Jobs that have finished execution. FEATURE STATE: Kubernetes v1.23 [stable] When your Job has finished, it's 
