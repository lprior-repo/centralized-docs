---
id: ref/docs-concepts-scheduling-eviction-taint-and-toleration.md/docs-concepts-scheduling-eviction-taint-and-toleration
title: Taints and Tolerations
category: ref
tags: ["concepts", "contents", "ref", "table", "taints"]
---
...
# Taints and Tolerations
 ...
 > 
 > **Context**: Node affinity is a property of  Pods  that  attracts  them to a set of  nodes  (either as a preference or a hard requirement).  Taints  are the opposi
