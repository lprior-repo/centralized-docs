---
id: tutorial/docs-tasks-administer-cluster-memory-manager.md/docs-tasks-administer-cluster-memory-manager
title: Control Memory Management Policies on a Node
category: tutorial
tags: ["before", "begin", "contents", "control", "management"]
---

## Table of Contents

* [Control Memory Management Policies on a Node](#control-memory-management-policies-on-a-node)
  * [Before you begin](#before-you-begin)
    * [Resource alignment prerequisites](#resource-alignment-prerequisites)
  * [How does the Memory Manager operate?](#how-does-the-memory-manager-operate)
  * [Memory Manager configuration](#memory-manager-configuration)
    * [Policies](#policies)
      * [Static policy](#static-policy)
      * [BestEffort policy](#besteffort-policy)
  * [Reserved memory configuration](#reserved-memory-configuration)
    * [Memory manager reserved memory syntax](#memory-manager-reserved-memory-syntax)
    * [Constraints on NUMA memory reservation](#constraints-on-numa-memory-reservation)
      * [Note:](#note)
    * [Configurations to avoid](#configurations-to-avoid)
...
# Control Memory Management Policies on a Node
 ...
 > 
 > **Context**: FEATURE STATE: Kubernetes v1.32 [stable] (enabled by default) The Kubernetes  Memory Manager  enables the feature of guaranteed memory (and hugepages)
...
* [kube scheduler](./ref-docs-reference-command-line-tools-reference-kube-scheduler.md-docs-reference-command-line-tools-reference-kube-scheduler.md)
