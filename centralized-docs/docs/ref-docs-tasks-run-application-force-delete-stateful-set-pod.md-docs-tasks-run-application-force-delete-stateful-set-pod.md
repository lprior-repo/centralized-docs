---
id: ref/docs-tasks-run-application-force-delete-stateful-set-pod.md/docs-tasks-run-application-force-delete-stateful-set-pod
title: Force Delete StatefulSet Pods
category: ref
tags: ["before", "begin", "contents", "delete", "force"]
---

## Table of Contents

* [Force Delete StatefulSet Pods](#force-delete-statefulset-pods)
...
# Force Delete StatefulSet Pods
 ...
 > 
 > **Context**: This page shows how to delete Pods which are part of a stateful set , and explains the considerations to keep in mind when doing so.
...
* [Scale a StatefulSet](./tutorial-docs-tasks-run-application-scale-stateful-set.md-docs-tasks-run-application-scale-stateful-set.md)
