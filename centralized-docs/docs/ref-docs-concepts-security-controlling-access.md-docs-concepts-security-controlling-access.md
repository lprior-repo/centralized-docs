---
id: ref/docs-concepts-security-controlling-access.md/docs-concepts-security-controlling-access
title: Controlling Access to the Kubernetes API
category: ref
tags: ["access", "contents", "controlling", "kubernetes", "ref"]
---
...
# Controlling Access to the Kubernetes API
 ...
 > 
 > **Context**: This page provides an overview of controlling access to the Kubernetes API. Users access the  Kubernetes API  using  kubectl , client libraries, or by
