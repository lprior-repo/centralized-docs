...
// Re-export HNSW validators from the dedicated submodule.
#[path = "validation_hnsw.rs"]
mod hnsw;

pub(crate) use hnsw::{
    validate_hnsw_ef_construction, validate_hnsw_m, validate_max_chunk_keywords,
    validate_max_related_chunks,
};
...
/// Validate concurrency (1-128 inclusive)
