<<<<<<< conflict 1 of 1
+++++++ wmqpqryo a7cc18e6 "fix: repair all broken test files, compile against current API" (rebased revision)
...
\\\\\\\        to: lzsmumur 4d2b433b "feat: implement state layer beads (h70, bvh, bg3, ej0, b3v, pxx, 4s3, 2rt)" (parents of rebased revision)
 #![allow(clippy::pedantic)]
 #![allow(clippy::unwrap_used)]
 #![allow(clippy::expect_used)]
 #![allow(clippy::panic)]
