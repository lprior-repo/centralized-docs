---
id: ops/general/agents
title: AGENTS
category: ops
tags: ["agent", "instructions", "ops", "overview", "project"]
---

# AI Agent Instructions

> **Context**: This document is for Claude and other AI agents working on the codebase.
...
import (
    "gofr.dev/pkg/gofr"
    "github.com/lewisblake/centralized-docs/internal/app"
    "github.com/lewisblake/centralized-docs/internal/ports"
)

func CommandHandler(app app.Application) func(*gofr.Context) (any, error) {
...
import (
    "context"
    "github.com/lewisblake/centralized-docs/pkg/domain"
)

type Newinterface interface {
    Operation(ctx context.Context, param Type) domain.Result[ReturnType]
}
```
...
func New() ports.Interface {
    return &Adapter{}
}

func (a *Adapter) Operation(ctx context.Context, param Type) domain.Result[ReturnType] {
    // Implementation
}
```
...
2. `docs/VISION.md` - Project goals
3. `/home/lewis/.claude/plans/snoopy-tinkering-patterson.md` - Complete plan
4. Existing code in `internal/` - See patterns in action

---

**Remember**: The goal is "one way to do everything" - if you find yourself with choices, that's a design problem to fix.
## See Also
