...
What is AWS Lambda? - AWS Lambda
[](https://docs.aws.amazon.com/pdfs/lambda/latest/dg/lambda-dg.pdf#welcome)
[How Lambda works](#how-lambda-works)[Key features](#features)[Related information](#w2aab7c17)
###### Tip
Join Serverless experts for free hands-on workshops to learn how to build Serverless
applications with best practices. [Click here](https://aws-experience.com/amer/smb/events/series/Get-Hands-On-With-Serverless?trk=188abe3e-9f94-4e84-aefb-398d944ad567&sc_channel=el) to sign up.
