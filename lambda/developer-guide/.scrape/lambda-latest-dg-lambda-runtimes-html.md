...
Lambda runtimes - AWS Lambda
[](https://docs.aws.amazon.com/pdfs/lambda/latest/dg/lambda-dg.pdf#lambda-runtimes)
[Supported runtimes](#runtimes-supported)[New runtime releases](#runtimes-future)[Runtime deprecation policy](#runtime-support-policy)[Shared responsibility model](#runtimes-shared-responsibility)[Runtime use after deprecation](#runtime-deprecation-levels)[Receiving runtime deprecation notifications](#runtime-deprecation-notify)[Deprecated runtimes](#runtimes-deprecated)
# Lambda runtimes
...
Apply runtime updates automatically by default (see [Runtime update modes](./runtimes-update.html#runtime-management-controls) for non-default behaviors).
...
Notify customers prior to runtime deprecation via documentation, Health Dashboard, email, and Trusted Advisor.
Responsibility for runtime updates ends at deprecation.
|
Monitor Lambda documentation, Health Dashboard, email, or Trusted Advisor for runtime deprecation information.
...
|
* AWS sends notifications through email and the Health Dashboard to accounts that have functions using this runtime in their `$LATEST` version.
* Affected functions are also listed in the [Health Dashboard Scheduled changes tab](https://docs.aws.amazon.com/health/latest/ug/aws-health-account-views.html) and the [AWS Trusted Advisor deprecated runtimes check](https://docs.aws.amazon.com/awssupport/latest/user/security-checks.html#aws-lambda-functions-deprecated-runtimes).
|
|
Deprecation
|
...
* You can no longer create or update functions using the deprecated runtime in the Lambda console. You can continue to create and update functions through the AWS CLI, AWS SAM, or CloudFormation.
|
|
...
* You can continue to update code and configuration for existing functions through the AWS CLI, AWS SAM, or CloudFormation..
|
|
