---
url: https://docs.aws.amazon.com/lambda/latest/dg/kinesis-on-failure-destination.html
title: Retain discarded batch records for a Kinesis Data Streams event source in Lambda
word_count: 1503
filtered: true
elements_removed: 0
density_score: 0.86
...
Retain discarded batch records for a Kinesis Data Streams event source in Lambda - AWS Lambda
[](https://docs.aws.amazon.com/pdfs/lambda/latest/dg/lambda-dg.pdf#kinesis-on-failure-destination)
[On-failure destinations](#kinesis-on-failure-destination-console)
