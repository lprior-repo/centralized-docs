---
url: https://docs.aws.amazon.com/lambda/latest/dg/functions-states.html
...
Lambda function states - AWS Lambda
[](https://docs.aws.amazon.com/pdfs/lambda/latest/dg/lambda-dg.pdf#functions-states)
[Function states during updates](#functions-states-updating)
# Lambda function states
Lambda includes a [State](https://docs.aws.amazon.com/lambda/latest/api/API_GetFunctionConfiguration.html#lambda-GetFunctionConfiguration-response-State) field in the function configuration for all
...
###### Note
Function state definitions differ slightly for [SnapStart](./snapstart.html) functions. For more information, see [Lambda SnapStart and function states](./snapstart-activate.html#snapstart-function-states).
...
[
Amazon EFS for Lambda](https://aws.amazon.com/blogs/compute/using-amazon-efs-for-aws-lambda-in-your-serverless-applications/) if you are using this service, and this provides low-latency access to file system storage.
...
You can do this with the Lambda API action [GetFunction](https://docs.aws.amazon.com/lambda/latest/api/API_GetFunction.html), or by configuring a waiter using the
