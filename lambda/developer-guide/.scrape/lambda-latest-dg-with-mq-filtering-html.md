---
url: https://docs.aws.amazon.com/lambda/latest/dg/with-mq-filtering.html
title: Filter events from an Amazon MQ event source
word_count: 1196
filtered: true
elements_removed: 0
density_score: 0.82
...
Filter events from an Amazon MQ event source - AWS Lambda
Filter events from an Amazon MQ event source - AWS Lambda
[](https://docs.aws.amazon.com/pdfs/lambda/latest/dg/lambda-dg.pdf#with-mq-filtering)
