---
url: https://docs.aws.amazon.com/lambda/latest/dg/golang-tracing.html
title: Instrumenting Go code in AWS Lambda
word_count: 1438
filtered: true
elements_removed: 0
density_score: 0.87
...
* [AWS X-Ray SDK for Go](https://docs.aws.amazon.com/xray/latest/devguide/xray-sdk-go.html) – An SDK
...
Support for Go](https://aws-otel.github.io/docs/getting-started/lambda/lambda-go) in the ADOT documentation.
...
you can also use the AWS X-Ray SDK for Go. To get the SDK, download the SDK from its [GitHub repository](https://github.com/aws/aws-xray-sdk-go) with `go get`:
```
``go get github.com/aws/aws-xray-sdk-go``
```
To instrument AWS SDK clients, pass the client to the `xray.AWS()` method. You can then
trace calls by using the `WithContext` version of the method.
```
`
...
with annotations and metadata. For more information, see the [AWS X-Ray SDK for Go](https://docs.aws.amazon.com/xray/latest/devguide/xray-sdk-python.html) in the
