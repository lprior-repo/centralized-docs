---
url: https://docs.aws.amazon.com/lambda/latest/dg/dotnet-csharp-testing.html
title: dotnet csharp testing.html
word_count: 821
filtered: true
elements_removed: 0
density_score: 0.84
...
AWS Lambda function testing in C# - AWS Lambda
[](https://docs.aws.amazon.com/pdfs/lambda/latest/dg/lambda-dg.pdf#dotnet-csharp-testing)
[Testing your serverless applications](#dotnet-csharp-testing-techniques-for-serverless-applications)
###### Note
See the [Testing functions](./testing-guide.html) chapter for a complete introduction to techniques and best practices for testing serverless solutions.
...
###### Note
[Testing a function in the console](./testing-functions.html) is a quick way to get started, but automating your test cycles ensures application quality and development speed.
### Testing tools
...
[AWS SAM Accelerate](https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/using-sam-cli-sync.html) and
[AWS CDK watch mode](https://docs.aws.amazon.com/cdk/v2/guide/cli.html#cli-deploy-watch) both decrease the time required to update
cloud environments.
...
{
[Fact]
public async Task TestLambdaHandler\_WhenInputIsValid\_ShouldReturn200StatusCode()
{
// Arrange
...
```
For more detailed examples, including examples of asynchronous tests, see the [.NET testing samples repository](https://github.com/aws-samples/serverless-test-samples/tree/main/dotnet-test-samples)
on GitHub.
