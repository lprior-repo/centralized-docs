---
url: https://docs.aws.amazon.com/lambda/latest/dg/nodejs-image.html
title: Deploy Node.js Lambda functions with container images
word_count: 3508
filtered: true
elements_removed: 0
density_score: 0.90
...
Deploy Node.js Lambda functions with container images - AWS Lambda
[](https://docs.aws.amazon.com/pdfs/lambda/latest/dg/lambda-dg.pdf#nodejs-image)
[AWS base images for Node.js](#nodejs-image-base)[Using an AWS base image](#nodejs-image-instructions)[Using a non-AWS base image](#nodejs-image-clients)
...
|
24
|Node.js 24|Amazon Linux 2023|[Dockerfile
for Node.js 24 on GitHub](https://github.com/aws/aws-lambda-base-images/blob/nodejs24.x/Dockerfile.nodejs24.x)|
Apr 30, 2028
|
|
22
|Node.js 22|Amazon Linux 2023|[Dockerfile
for Node.js 22 on GitHub](https://github.com/aws/aws-lambda-base-images/blob/nodejs22.x/Dockerfile.nodejs22.x)|
Apr 30, 2027
|
|
20
|Node.js 20|Amazon Linux 2023|[Dockerfile
for Node.js 20 on GitHub](https://github.com/aws/aws-lambda-base-images/blob/nodejs20.x/Dockerfile.nodejs20.x)|
Apr 30, 2026
|
Amazon ECR repository: [gallery.ecr.aws/lambda/nodejs](https://gallery.ecr.aws/lambda/nodejs)
The Node.js 20 and later base images are based on the [Amazon Linux 2023 minimal container image](https://docs.aws.amazon.com/linux/al2023/ug/minimal-container.html). Earlier base
...
```
4. If your function depends on libraries other than the AWS SDK for JavaScript, use [npm](https://www.npmjs.com/) to add them to your package.
...
image instead of an [AWS base image](./images-create.html#runtimes-images-lp). The
Dockerfile includes the [runtime
interface client](https://www.npmjs.com/package/aws-lambda-ric), which makes the image compatible with Lambda. The
Dockerfile uses a [multi-stage build](https://docs.docker.com/develop/develop-images/dockerfile_best-practices/#use-multi-stage-builds). The first stage creates a build image, which is a
...
ENV NPM\_CONFIG\_CACHE=/tmp/.npm
# Include global arg in this stage of the build
ARG FUNCTION\_DIR
