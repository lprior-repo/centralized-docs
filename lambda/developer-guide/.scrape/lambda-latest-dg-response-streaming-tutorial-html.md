---
url: https://docs.aws.amazon.com/lambda/latest/dg/response-streaming-tutorial.html
title: Tutorial: Creating a response streaming Lambda
word_count: 1034
filtered: true
elements_removed: 0
density_score: 0.88
...
Tutorial: Creating a response streaming Lambda function with a function URL - AWS Lambda
[](https://docs.aws.amazon.com/pdfs/lambda/latest/dg/lambda-dg.pdf#response-streaming-tutorial)
[Prerequisites](#response-streaming-prepare)[Create an execution role](#response-streaming-create-iam-role)[Create a response streaming
function (AWS CLI)](#response-streaming-tutorial-create-function-cli)[Test the function URL endpoint](#response-streaming-tutorial-test)[Clean up your resources](#cleanup)
...
function URLs, see [Function URLs](./urls-configuration.html).
## Prerequisites
...
Create the [execution role](./lambda-intro-execution-role.html) that gives your Lambda function permission to access AWS
resources.
...
```
Our function URL uses the `IAM\_AUTH` authentication type. This means that you
need to sign requests with both your [AWS access key and secret key](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_access-keys.html). In the previous command,
...
temporary AWS credentials](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_request.html) instead.
