---
url: https://docs.aws.amazon.com/lambda/latest/dg/services-appcomposer.html
title: Using AWS Lambda with AWS Infrastructure Composer
word_count: 777
filtered: true
elements_removed: 0
density_score: 0.88
...
Using AWS Lambda with AWS Infrastructure Composer - AWS Lambda
Using AWS Lambda with AWS Infrastructure Composer - AWS Lambda
[](https://docs.aws.amazon.com/pdfs/lambda/latest/dg/lambda-dg.pdf#services-appcomposer)
[Exporting a Lambda function to Infrastructure Composer](#services-appcomposer-export)[Other resources](#w2aad101c33b7)
...
[AWS SAM](https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/what-is-sam.html) or
...
4. In the dialog box, choose **Confirm and create project** to accept the default name for this bucket and export your function's
configuration and code to Infrastructure Composer.
5. (Optional) To choose another name for the Amazon S3 bucket that Lambda creates, enter a new name and choose **Confirm and create project**.
...
6. To save your project and function files in Infrastructure Composer, activate [local sync mode](https://docs.aws.amazon.com/application-composer/latest/dg/reference-features-local-sync.html).
###### Note
...
standard. Lambda also configures the bucket to use the [bucket owner condition](https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucket-owner-condition.html)
...
automaticaly delete the bucket itself. To delete the bucket from your AWS account, follow the instructions in [Deleting a bucket](https://docs.aws.amazon.com/AmazonS3/latest/userguide/delete-bucket.html).
...
You can grant permission to use all of these actions by adding the [`AWSLambda\_ReadOnlyAccess`](https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSLambda_ReadOnlyAccess.html)
...
[resource-based policies](./access-control-resource-based.html) that might limit access to Amazon S3.
## Other resources
...
[Using Lambda with infrastructure as code (IaC)](./foundation-iac.html).
...
follow the [AWS Infrastructure Composer tutorial](https://catalog.workshops.aws/serverless-patterns/en-US/dive-deeper/module1a) in the
[AWS Serverless Patterns Workshop](https://catalog.workshops.aws/serverless-patterns/en-US).
