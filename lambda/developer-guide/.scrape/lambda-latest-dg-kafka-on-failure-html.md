---
url: https://docs.aws.amazon.com/lambda/latest/dg/kafka-on-failure.html
title: Capturing discarded batches for Amazon MSK and self-managed Apache Kafka event sources
word_count: 1462
filtered: true
elements_removed: 0
density_score: 0.83
...
Capturing discarded batches for Amazon MSK and self-managed Apache Kafka event sources - AWS Lambda
Capturing discarded batches for Amazon MSK and self-managed Apache Kafka event sources - AWS Lambda
[](https://docs.aws.amazon.com/pdfs/lambda/latest/dg/lambda-dg.pdf#kafka-on-failure)
[Configuring on-failure destinations for a Kafka event source mapping](#kafka-onfailure-destination)
...
With Amazon S3 destinations, you can use the [Amazon S3 Event Notifications](https://docs.aws.amazon.com/) feature to receive notifications when objects are uploaded to
...
[kms:GenerateDataKey](https://docs.aws.amazon.com/kms/latest/APIReference/API_GenerateDataKey.html) is required.
...
[kms:Decrypt](https://docs.aws.amazon.com/kms/latest/APIReference/API_Decrypt.html) and
[kms:GenerateDataKey](https://docs.aws.amazon.com/kms/latest/APIReference/API_GenerateDataKey.html) are
...
[kms:DescribeKey](https://docs.aws.amazon.com/kms/latest/APIReference/API_DescribeKey.html), and
...
[create-event-source-mapping](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/create-event-source-mapping.html) command adds an event source mapping with an SQS on-failure destination to
`MyFunction`:
```
