---
url: https://docs.aws.amazon.com/lambda/latest/dg/with-kafka-permissions.html
title: Configuring Lambda execution role permissions
word_count: 580
filtered: true
elements_removed: 0
density_score: 0.84
...
Configuring Lambda execution role permissions - AWS Lambda
[](https://docs.aws.amazon.com/pdfs/lambda/latest/dg/lambda-dg.pdf#with-kafka-permissions)
[Required Lambda function permissions](#smaa-api-actions-required)[Optional Lambda function permissions](#smaa-api-actions-optional)[Adding permissions](#smaa-permissions-add-policy)[Adding users to an IAM policy](#smaa-permissions-add-users)
# Configuring Lambda execution role permissions
In addition to [accessing your self-managed Kafka cluster](./kafka-cluster-auth.html), your Lambda function needs permissions to perform
various API actions. You add these permissions to the function's [execution role](./lambda-intro-execution-role.html). If your users need access to any API actions, add the required permissions to the
...
define in your Lambda function's [execution role](./lambda-intro-execution-role.html).
...
must create and define these actions in an [IAM trust policy](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_update-role-trust-policy.html) for your execution role. This example shows how you might create a policy that allows
...
By default, users and roles don't have permission to perform [event source API operations](./invocation-eventsourcemapping.html#event-source-mapping-api). To grant access to users in your
...
using policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_controlling.html) in the *IAM User Guide*.
