---
url: https://docs.aws.amazon.com/lambda/latest/dg/kafka-esm-parameters.html
title: All self-managed Apache Kafka event source configuration parameters in Lambda
word_count: 477
filtered: true
elements_removed: 0
density_score: 0.86
...
All self-managed Apache Kafka event source configuration parameters in Lambda - AWS Lambda
All self-managed Apache Kafka event source configuration parameters in Lambda - AWS Lambda
[](https://docs.aws.amazon.com/pdfs/lambda/latest/dg/lambda-dg.pdf#kafka-esm-parameters)
...
For SASL\_PLAIN, set to BASIC\_AUTH
|
|
StartingPosition
|
