---
url: https://docs.aws.amazon.com/lambda/latest/dg/with-kafka-cluster-network.html
title: Configuring your self-managed Apache Kafka cluster and network for Lambda
word_count: 962
filtered: true
elements_removed: 0
density_score: 0.78
...
Configuring your self-managed Apache Kafka cluster and network for Lambda - AWS Lambda
Configuring your self-managed Apache Kafka cluster and network for Lambda - AWS Lambda
[](https://docs.aws.amazon.com/pdfs/lambda/latest/dg/lambda-dg.pdf#with-kafka-cluster-network)
[Self-managed Apache Kafka cluster setup](#kafka-cluster-setup)[Configure network security](#services-kafka-vpc-config)
...
already configured properly, see [Configuring self-managed Apache Kafka event sources for Lambda](./with-kafka-configure.html) to configure the event source mapping.
###### Topics
...
You can host your self-managed Apache Kafka cluster with cloud providers such as [Confluent Cloud](https://www.confluent.io/confluent-cloud/)
or [Redpanda](https://www.redpanda.com/), or run it on your own infrastructure. Ensure that your cluster is properly configured
...
When you use self-managed Apache Kafka with Lambda, create [AWS PrivateLink VPC endpoints](https://docs.aws.amazon.com/vpc/latest/privatelink/create-interface-endpoint.html) that provide your function
