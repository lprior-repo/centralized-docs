...
title: Logging AWS Lambda API calls using
word_count: 1766
filtered: true
elements_removed: 0
density_score: 0.86
...
Logging AWS Lambda API calls using AWS CloudTrail - AWS Lambda
[](https://docs.aws.amazon.com/pdfs/lambda/latest/dg/lambda-dg.pdf#logging-using-cloudtrail)
[Lambda data events in CloudTrail](#cloudtrail-data-events)[Lambda management events in CloudTrail](#cloudtrail-management-events)[Using CloudTrail to troubleshoot disabled Lambda event sources](#cloudtrail-ESM-troubleshooting)[Lambda event examples](#cloudtrail-event-examples)
# Logging AWS Lambda API calls using
AWS CloudTrail
AWS Lambda is integrated with [AWS CloudTrail](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-user-guide.html), a service
...
[Using CloudTrail to troubleshoot disabled Lambda event sources](#cloudtrail-ESM-troubleshooting).
...
[AdvancedFieldSelector](https://docs.aws.amazon.com/awscloudtrail/latest/APIReference/API_AdvancedFieldSelector.html) in the
...
* [CreateEventSourceMapping](https://docs.aws.amazon.com/lambda/latest/api/API_CreateEventSourceMapping.html) (event name:
...
* [DeleteEventSourceMapping](https://docs.aws.amazon.com/lambda/latest/api/API_DeleteEventSourceMapping.html) (event name:
...
* [DeleteFunctionConcurrency](https://docs.aws.amazon.com/lambda/latest/api/API_DeleteFunctionConcurrency.html) (event name:
...
* [PublishLayerVersion](https://docs.aws.amazon.com/lambda/latest/api/API_PublishLayerVersion.html) (event name:
...
* [PutFunctionConcurrency](https://docs.aws.amazon.com/lambda/latest/api/API_PutFunctionConcurrency.html) (event name:
...
* [UpdateEventSourceMapping](https://docs.aws.amazon.com/lambda/latest/api/API_UpdateEventSourceMapping.html) (event name:
`UpdateEventSourceMapping20150331`)
* [UpdateFunctionCode](https://docs.aws.amazon.com/lambda/latest/api/API_UpdateFunctionCode.html) (event name:
`UpdateFunctionCode20150331v2`)
(The `ZipFile` parameter is omitted from the CloudTrail logs for
`UpdateFunctionCode`.)
* [UpdateFunctionConfiguration](https://docs.aws.amazon.com/lambda/latest/api/API_UpdateFunctionConfiguration.html) (event name:
...
When you change the state of an event source mapping using the [UpdateEventSourceMapping](https://docs.aws.amazon.com/lambda/latest/api/API_UpdateEventSourceMapping.html) API action, the
...
CloudTrail events: examples](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudwatch-alarms-for-cloudtrail.html).
