---
url: https://docs.aws.amazon.com/lambda/latest/dg/java-samples.html
title: Java sample applications for AWS Lambda
word_count: 515
filtered: true
elements_removed: 0
density_score: 0.88
...
Java sample applications for AWS Lambda - AWS Lambda
[](https://docs.aws.amazon.com/pdfs/lambda/latest/dg/lambda-dg.pdf#java-samples)
...
with Lambda event sources, see the `java-events` examples. Both of these example sets show the use of
