---
id: tutorial/ai_usage_guide.md/ai_usage_guide
title: Integrating AI Agents With Centralized Docs
category: tutorial
tags: [""lost", "`llms.txt`", "agents", "centralized", "effect"]
---
...
# Integrating AI Agents with Centralized Docs
 ...
 > 
 > **Context**: The primary goal of `centralized-docs` (`doc_transformer`) is to dramatically reduce the token footprint required to give AI agents (like Claude, GPT-
...
1. **Context Loss:** If you break a large markdown file into chunks blindly, a chunk that says “Run `make install`” loses the context of what header it was under. Was it under “Linux Installation” or “Windows Installation”? The agent hallucinates because it lost the semantic context.
