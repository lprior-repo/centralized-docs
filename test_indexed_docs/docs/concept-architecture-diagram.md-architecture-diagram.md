---
id: concept/architecture-diagram.md/architecture-diagram
title: Architecture Diagrams
category: concept
tags: ["architecture", "concept", "diagrams", "overview", "pipeline"]
---
...
# Architecture Diagrams
 ...
 > 
 > **Context**: Visual representations of the hexagonal architecture and data flow in `doc_transformer`.
