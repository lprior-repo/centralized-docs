---
id: concept/indexer_implementation_guide.md/indexer_implementation_guide
title: Indexer Implementation Guide
category: concept
tags: ["build", "commands", "concept", "implementation", "indexer"]
---
...
# Indexer Implementation Guide
 ...
 > 
 > **Context**: Technical details on `doc_transformer` indexer.
