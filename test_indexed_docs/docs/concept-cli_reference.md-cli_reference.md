---
id: concept/cli_reference.md/cli_reference
title: CLI Reference
category: concept
tags: ["`doc_transformer`", "commands", "concept", "reference"]
---
...
# CLI Reference
 ...
 > 
 > **Context**: The `doc_transformer` CLI provides tools to scrape, index, and search documentation.
