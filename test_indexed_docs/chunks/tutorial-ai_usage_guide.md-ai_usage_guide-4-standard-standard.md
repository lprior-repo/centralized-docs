...
chunk_id: tutorial/ai_usage_guide.md/ai_usage_guide#4-standard
chunk_level: standard
chunk_type: prose
heading: Token Efficiency Benchmarks
token_count: 237
summary: # Integrating AI Agents with Centralized Docs. ## Advanced Usage: Traversing the Knowledge DAG
---
