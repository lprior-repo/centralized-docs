...
chunk_id: tutorial/ai_usage_guide.md/ai_usage_guide#2-standard
chunk_level: standard
chunk_type: prose
heading: The Solution: The `llms.txt` Entry Point
token_count: 475
summary: # Integrating AI Agents with Centralized Docs.  **Token Exhaustion:** A large library like Kubernetes or FastAPI has over 1 million words of documentation
---
