...
"#),
        ...
        TestCase {
            ...
            files: vec![
                ("intro.md", "# Introduction\n\nStart with [Getting Started](./start.md) or [API](./api.md)."),
                ("start.md", "# Getting Started\n\nSee also: [Introduction](./intro.md), [Advanced](./adv.md)."),
                ("api.md", "# API Reference\n\nLinked from [Introduction](./intro.md)."),
                ("adv.md", "# Advanced\n\nAdvanced topics linked from [Getting Started](./start.md)."),
            ],
            expected_min_files: 4,
            should_succeed: true,
        },
