...
fn long_document_test_cases() -> Vec<ChunkingEdgeCase> {
    vec![
        ...
        ChunkingEdgeCase {
            ...
            content: "# Title\n\nFirst sentence with lots of words. Second sentence continues. Third sentence adds more. Fourth sentence extends further. Fifth sentence goes on. Sixth continues the pattern. Seventh adds information. Eighth extends it further. Ninth keeps going. Tenth wraps up.".to_string(),
            chunk_level: ChunkLevel::Standard,
            expected_min_chunks: 1,
            expected_max_chunks: 1,
            expect_non_empty: true,
...
fn unicode_test_cases() -> Vec<ChunkingEdgeCase> {
    vec![
        ...
        ChunkingEdgeCase {
            ...
            content: "# Emoji Variants 👨‍👩‍👧‍👦\n\n👋 Wave\n👋🏻 Light skin tone\n👋🏿 Dark skin tone\n\n🏳️‍🌈 Rainbow flag\n⚪ Variations\n\nContent continues here.".to_string(),
            chunk_level: ChunkLevel::Standard,
            expected_min_chunks: 1,
            expected_max_chunks: 2,
            expect_non_empty: true,
