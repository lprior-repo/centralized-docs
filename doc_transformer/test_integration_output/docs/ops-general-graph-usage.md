---
id: ops/general/graph-usage
title: GRAPH USAGE
category: ops
tags: ["graph", "knowledge", "ops", "overview", "subcommand"]
---

# Graph Subcommand - Knowledge DAG Traversal


> **Context**: The `graph` subcommand allows you to explore the knowledge graph relationships between documents and chunks in your documentation.
...
- Chunks become nodes
- Parent-child edges link documents to their chunks
- Sequential edges link chunks in reading order
- Related edges connect semantically similar chunks (Jaccard similarity ≥ 0.3)
