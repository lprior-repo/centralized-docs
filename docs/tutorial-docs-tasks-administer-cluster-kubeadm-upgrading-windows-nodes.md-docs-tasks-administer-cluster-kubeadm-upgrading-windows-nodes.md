---
id: tutorial/docs-tasks-administer-cluster-kubeadm-upgrading-windows-nodes.md/docs-tasks-administer-cluster-kubeadm-upgrading-windows-nodes
title: Upgrading Windows nodes
category: tutorial
tags: ["before", "begin", "contents", "nodes", "table"]
---
...
# Upgrading Windows nodes
 ...
 > 
 > **Context**: FEATURE STATE: Kubernetes v1.18 [beta] This page explains how to upgrade a Windows node created with kubeadm.
