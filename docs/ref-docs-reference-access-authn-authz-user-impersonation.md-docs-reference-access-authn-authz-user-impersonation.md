---
id: ref/docs-reference-access-authn-authz-user-impersonation.md/docs-reference-access-authn-authz-user-impersonation
title: User Impersonation
category: ref
tags: ["contents", "impersonation", "note:", "ref", "table"]
---
...
# User Impersonation
 ...
 > 
 > **Context**: User  impersonation  is a method of allowing authenticated users to act as another user, group, or service account through HTTP headers. A user can ac
...
1. **Permission to perform specific actions at a particular scope when impersonating** (for
