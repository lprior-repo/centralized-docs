---
id: tutorial/docs-tasks-tls-certificate-rotation.md/docs-tasks-tls-certificate-rotation
title: Configure Certificate Rotation for the Kubelet
category: tutorial
tags: ["before", "begin", "certificate", "configure", "contents"]
---
...
# Configure Certificate Rotation for the Kubelet
 ...
 > 
 > **Context**: This page shows how to enable and configure certificate rotation for the kubelet. FEATURE STATE: Kubernetes v1.19 [stable]
