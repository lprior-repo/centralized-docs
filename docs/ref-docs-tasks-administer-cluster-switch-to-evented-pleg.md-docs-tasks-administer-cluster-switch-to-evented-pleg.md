---
id: ref/docs-tasks-administer-cluster-switch-to-evented-pleg.md/docs-tasks-administer-cluster-switch-to-evented-pleg
title: Switching from Polling to CRI Event-based Updates to Container Status
category: ref
tags: ["container", "contents", "event-based", "polling", "ref"]
---
...
# Switching from Polling to CRI Event-based Updates to Container Status
 ...
 > 
 > **Context**: Switching from Polling to CRI Event-based Updates to Container Status | Kubernetes



### Table of Contents

* [Switching from Polling to CRI Event-based Updates to Container Status](#switching-from-polling-to-cri-event-based-updates-to-container-status)
* [Switching from Polling to CRI Event-based Updates to Container Status](#switching-from-polling-to-cri-event-based-updates-to-container-status)
...
Switching from Polling to CRI Event-based Updates to Container Status | Kubernetes
...
1. Make sure the node is [drained](/docs/tasks/administer-cluster/safely-drain-node/) before proceeding.
1. Start the container runtime with the container event generation enabled.
   Version 1.7+
   Version 1.26+
...
Last modified February 20, 2024 at 9:48 AM PST: [Switch more feature-state shortcodes to be data driven (7b6866063f)](https://github.com/kubernetes/website/commit/7b6866063f4feded1f47679baf73f2844b3ad491)
...
* [Configuring a cgroup driver](./ref-docs-tasks-administer-cluster-kubeadm-configure-cgroup-driver.md-docs-tasks-administer-cluster-kubeadm-configure-cgroup-driver.md)
...
* [Understand Pressure Stall Information (PSI) Metrics](./ref-docs-reference-instrumentation-understand-psi-metrics.md-docs-reference-instrumentation-understand-psi-metrics.md)
## See Also
