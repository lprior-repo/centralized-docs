---
id: tutorial/docs-tutorials-kubernetes-basics-deploy-app.md/docs-tutorials-kubernetes-basics-deploy-app
title: Docs Tutorials Kubernetes Basics Deploy App
category: tutorial
tags: ["contents", "feedback", "pages", "related", "table"]
---

# Docs Tutorials Kubernetes Basics Deploy App



 > 
 > **Context**: Was this page helpful? Yes No Thanks for the feedback. If you have a specific, answerable question about how to use Kubernetes, ask it on Stack Overfl
