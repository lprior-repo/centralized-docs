---
id: ref/docs-concepts-containers-container-lifecycle-hooks.md/docs-concepts-containers-container-lifecycle-hooks
title: Container Lifecycle Hooks
category: ref
tags: ["container", "contents", "hooks", "lifecycle", "overview"]
---
...
* [Container Lifecycle Hooks](#container-lifecycle-hooks)
  ...
  * [Container hooks](#container-hooks)
    ...
    * [Debugging Hook handlers](#debugging-hook-handlers)
...
# Container Lifecycle Hooks
 ...
 > 
 > **Context**: This page describes how kubelet managed Containers can use the Container lifecycle hook framework to run code triggered by events during their managem
