---
id: tutorial/docs-tasks-administer-cluster-dns-debugging-resolution.md/docs-tasks-administer-cluster-dns-debugging-resolution
title: Debugging DNS Resolution
category: tutorial
tags: ["before", "begin", "contents", "debugging", "resolution"]
---
...
# Debugging DNS Resolution
 ...
 > 
 > **Context**: This page provides hints on diagnosing DNS problems.
