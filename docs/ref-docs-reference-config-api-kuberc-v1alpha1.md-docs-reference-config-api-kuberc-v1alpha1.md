---
id: ref/docs-reference-config-api-kuberc-v1alpha1.md/docs-reference-config-api-kuberc-v1alpha1
title: Docs Reference Config Api Kuberc V1alpha1
category: ref
tags: ["aliasoverride", "contents", "ref", "resource", "table"]
---

# Docs Reference Config Api Kuberc V1alpha1
