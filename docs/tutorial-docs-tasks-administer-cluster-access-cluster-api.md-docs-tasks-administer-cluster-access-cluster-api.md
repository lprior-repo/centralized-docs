---
id: tutorial/docs-tasks-administer-cluster-access-cluster-api.md/docs-tasks-administer-cluster-access-cluster-api
title: Access Clusters Using the Kubernetes API
category: tutorial
tags: ["access", "before", "begin", "clusters", "contents"]
---
...
# Access Clusters Using the Kubernetes API
 ...
 > 
 > **Context**: This page shows how to access clusters using the Kubernetes API.
