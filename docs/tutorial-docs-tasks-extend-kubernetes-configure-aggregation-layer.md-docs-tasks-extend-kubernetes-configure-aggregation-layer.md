---
id: tutorial/docs-tasks-extend-kubernetes-configure-aggregation-layer.md/docs-tasks-extend-kubernetes-configure-aggregation-layer
title: Configure the Aggregation Layer
category: tutorial
tags: ["aggregation", "before", "begin", "configure", "contents"]
---
...
# Configure the Aggregation Layer
 ...
 > 
 > **Context**: Configuring the  aggregation layer allows the Kubernetes apiserver to be extended with additional APIs, which are not part of the core Kubernetes APIs
...
1. Kubernetes apiserver: proxy the request to the extension apiserver
1. Extension apiserver: authenticate the request from the Kubernetes apiserver
1. Extension apiserver: authorize the request from the original user
1. Extension apiserver: execute
...
1. How should the Kubernetes apiserver inform the extension apiserver of the
...
1. The connection must be made using a client certificate whose CN is one of
...
1. Create a configmap in the `kube-system` namespace called `extension-apiserver-authentication`,
...
* [User Impersonation](./ref-docs-reference-access-authn-authz-user-impersonation.md-docs-reference-access-authn-authz-user-impersonation.md)
* [Extending the Kubernetes API](./tutorial-docs-concepts-extend-kubernetes-api-extension.md-docs-concepts-extend-kubernetes-api-extension.md)
