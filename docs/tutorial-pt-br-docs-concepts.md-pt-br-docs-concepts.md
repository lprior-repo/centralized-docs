---
id: tutorial/pt-br-docs-concepts.md/pt-br-docs-concepts
title: Conceitos
category: tutorial
tags: ["conceitos", "contents", "geral", "table", "tutorial"]
---
...
# Conceitos
 ...
 > 
 > **Context**: A seção de Conceitos irá te ajudar a aprender mais sobre as partes do ecossistema Kubernetes e as abstrações que o Kubernetes usa para representar seu
