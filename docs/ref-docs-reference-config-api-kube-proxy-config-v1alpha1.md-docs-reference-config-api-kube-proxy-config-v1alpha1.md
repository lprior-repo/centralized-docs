---
id: ref/docs-reference-config-api-kube-proxy-config-v1alpha1.md/docs-reference-config-api-kube-proxy-config-v1alpha1
title: Docs Reference Config Api Kube Proxy Config V1alpha1
category: ref
tags: ["contents", "jsonoptions", "ref", "resource", "table"]
---

# Docs Reference Config Api Kube Proxy Config V1alpha1
...
* [kube-apiserver Configuration (v1beta1)](./ref-docs-reference-config-api-apiserver-config-v1beta1.md-docs-reference-config-api-apiserver-config-v1beta1.md)
