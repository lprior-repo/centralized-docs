---
id: tutorial/docs-tasks-access-application-cluster-service-access-application-cluster.md/docs-tasks-access-application-cluster-service-access-application-cluster
title: Use a Service to Access an Application in a Cluster
category: tutorial
tags: ["access", "application", "cluster", "contents", "service"]
---
...
# Use a Service to Access an Application in a Cluster
 ...
 > 
 > **Context**: Use a Service to Access an Application in a Cluster | Kubernetes
...
7. Get the public IP address of one of your nodes that is running
   ...
   nodes.
7. On your chosen node, create a firewall rule that allows TCP traffic
...
7. Use the node address and node port to access the Hello World application:
