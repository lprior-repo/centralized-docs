---
id: ref/docs-concepts-cluster-administration-kube-state-metrics.md/docs-concepts-cluster-administration-kube-state-metrics
title: Metrics for Kubernetes Object States
category: ref
tags: ["cluster", "contents", "example:", "kube-state-metrics", "kubernetes"]
---
...
# Metrics for Kubernetes Object States
 ...
 > 
 > **Context**: kube-state-metrics, an add-on agent to generate and expose cluster-level metrics. The state of Kubernetes objects in the Kubernetes API can be exposed
