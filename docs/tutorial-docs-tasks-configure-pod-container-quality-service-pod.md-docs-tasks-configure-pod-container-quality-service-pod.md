---
id: tutorial/docs-tasks-configure-pod-container-quality-service-pod.md/docs-tasks-configure-pod-container-quality-service-pod
title: Configure Quality of Service for Pods
category: tutorial
tags: ["configure", "contents", "note:", "quality", "service"]
---
...
# Configure Quality of Service for Pods
 ...
 > 
 > **Context**: This page shows how to configure Pods so that they will be assigned particular Quality of Service (QoS) classes . Kubernetes uses QoS classes to make 
...
* [Pod Priority and Preemption](./ref-docs-concepts-scheduling-eviction-pod-priority-preemption.md-docs-concepts-scheduling-eviction-pod-priority-preemption.md)
