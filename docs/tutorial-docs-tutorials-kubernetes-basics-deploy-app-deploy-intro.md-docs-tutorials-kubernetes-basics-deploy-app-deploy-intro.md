---
id: tutorial/docs-tutorials-kubernetes-basics-deploy-app-deploy-intro.md/docs-tutorials-kubernetes-basics-deploy-app-deploy-intro
title: Docs Tutorials Kubernetes Basics Deploy App Deploy Intro
category: tutorial
tags: ["contents", "deployments", "kubernetes", "objectives", "table"]
---
...
# Docs Tutorials Kubernetes Basics Deploy App Deploy Intro
 ...
 > 
 > **Context**: A Deployment is responsible for creating and updating instances of your application.
