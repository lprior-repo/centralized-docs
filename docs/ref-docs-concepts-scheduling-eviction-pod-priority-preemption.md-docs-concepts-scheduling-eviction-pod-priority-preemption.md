---
id: ref/docs-concepts-scheduling-eviction-pod-priority-preemption.md/docs-concepts-scheduling-eviction-pod-priority-preemption
title: Pod Priority and Preemption
category: ref
tags: ["contents", "preemption", "priority", "ref", "table"]
---
...
# Pod Priority and Preemption
 ...
 > 
 > **Context**: FEATURE STATE: Kubernetes v1.14 [stable] Pods  can have  priority . Priority indicates the importance of a Pod relative to other Pods. If a Pod cannot
