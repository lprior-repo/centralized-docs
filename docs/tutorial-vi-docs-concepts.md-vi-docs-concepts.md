---
id: tutorial/vi-docs-concepts.md/vi-docs-concepts
title: Các khái niệm
category: tutorial
tags: ["contents", "khái", "niệm", "service", "table"]
---
...
# Các khái niệm
 ...
 > 
 > **Context**: Phần Khái niệm giúp bạn tìm hiểu về các bộ phận của hệ thống Kubernetes và các khái niệm mà Kubernetes sử dụng để biểu diễn  cụm cluster  của bạn, đồn
