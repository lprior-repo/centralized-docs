---
id: ref/docs-concepts-configuration-secret.md/docs-concepts-configuration-secret
title: Secrets
category: ref
tags: ["caution:", "contents", "ref", "secrets", "table"]
---
...
# Secrets
 ...
 > 
 > **Context**: A Secret is an object that contains a small amount of sensitive data such as a password, a token, or a key. Such information might otherwise be put in
