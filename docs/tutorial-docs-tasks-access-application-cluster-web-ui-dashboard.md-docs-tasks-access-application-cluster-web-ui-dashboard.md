---
id: tutorial/docs-tasks-access-application-cluster-web-ui-dashboard.md/docs-tasks-access-application-cluster-web-ui-dashboard
title: Deploy and Access the Kubernetes Dashboard
category: tutorial
tags: ["access", "contents", "dashboard", "deploy", "kubernetes"]
---

## Table of Contents

* [Deploy and Access the Kubernetes Dashboard](#deploy-and-access-the-kubernetes-dashboard)
  * [Note:](#note)
  * [Note:](#note)
* [Deploy a Helm Release named “kubernetes-dashboard” using the kubernetes-dashboard chart](#deploy-a-helm-release-named-kubernetes-dashboard-using-the-kubernetes-dashboard-chart)
  * [Accessing the Dashboard UI](#accessing-the-dashboard-ui)
    * [Warning:](#warning)
    * [Command line proxy](#command-line-proxy)
      * [Note:](#note)
  * [Welcome view](#welcome-view)
  * [Deploying containerized applications](#deploying-containerized-applications)
    * [Specifying application details](#specifying-application-details)
      * [Note:](#note)
    * [Uploading a YAML or JSON file](#uploading-a-yaml-or-json-file)
...
# Deploy and Access the Kubernetes Dashboard
 ...
 > 
 > **Context**: Deploy the web UI (Kubernetes Dashboard) and access it. Kubernetes Dashboard is deprecated and unmaintained. The Kubernetes Dashboard project has been
...
* [scale intro](./tutorial-docs-tutorials-kubernetes-basics-scale-scale-intro.md-docs-tutorials-kubernetes-basics-scale-scale-intro.md)
