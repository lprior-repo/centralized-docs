---
id: ref/docs-reference-access-authn-authz-rbac.md/docs-reference-access-authn-authz-rbac
title: Using RBAC Authorization
category: ref
tags: ["authorization", "contents", "objects", "ref", "table"]
---
...
# Using RBAC Authorization
 ...
 > 
 > **Context**: Role-based access control (RBAC) is a method of regulating access to computer or network resources based on the roles of individual users within your 
...
1. You are granted explicit permission to perform the `escalate` verb on the `roles` or
...
1. Grant them permission to include specific permissions in the roles they create/update:
...
1. Grant them permissions needed to bind a particular role:
