---
id: ref/docs-reference-kubernetes-api-policy-resources-validating-admission-policy-v1.md/docs-reference-kubernetes-api-policy-resources-validating-admission-policy-v1
title: ValidatingAdmissionPolicy
category: ref
tags: ["contents", "ref", "table", "validatingadmissionpolicy"]
---
...
# ValidatingAdmissionPolicy
 ...
 > 
 > **Context**: ValidatingAdmissionPolicy describes the definition of an admission validation policy that accepts or rejects an object without changing it. apiVersion
...
* **body**: [ValidatingAdmissionPolicy](https://kubernetes.io/docs/reference/kubernetes-api/policy-resources/validating-admission-policy-binding-v1/#ValidatingAdmissionPolicy), required
...
202 ([ValidatingAdmissionPolicy](https://kubernetes.io/docs/reference/kubernetes-api/policy-resources/validating-admission-policy-binding-v1/#ValidatingAdmissionPolicy)): Accepted
401: Unauthorized
...
* [ServiceAccount](./ref-docs-reference-kubernetes-api-authentication-resources-service-account-v1.md-docs-reference-kubernetes-api-authentication-resources-service-account-v1.md)
* [Deploy and Access the Kubernetes Dashboard](./tutorial-docs-tasks-access-application-cluster-web-ui-dashboard.md-docs-tasks-access-application-cluster-web-ui-dashboard.md)
## See Also
