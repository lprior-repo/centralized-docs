---
id: ref/docs-concepts-policy-pid-limiting.md/docs-concepts-policy-pid-limiting
title: Process ID Limits And Reservations
category: ref
tags: ["contents", "limits", "note:", "process", "ref"]
---

## Table of Contents

* [Process ID Limits And Reservations](#process-id-limits-and-reservations)
  * [Note:](#note)
  * [Caution:](#caution)
  * [Node PID limits](#node-pid-limits)
...
# Process ID Limits And Reservations
 ...
 > 
 > **Context**: FEATURE STATE: Kubernetes v1.20 [stable] Kubernetes allow you to limit the number of process IDs (PIDs) that a Pod  can use. You can also reserve a nu
