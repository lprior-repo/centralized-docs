---
id: tutorial/docs-tutorials-configuration-pod-sidecar-containers.md/docs-tutorials-configuration-pod-sidecar-containers
title: Adopting Sidecar Containers
category: tutorial
tags: ["adopting", "containers", "contents", "objectives", "sidecar"]
---

## Table of Contents

* [Adopting Sidecar Containers](#adopting-sidecar-containers)
  * [Objectives](#objectives)
  * [Sidecar containers overview](#sidecar-containers-overview)
  * [Benefits of a built-in sidecar container](#benefits-of-a-built-in-sidecar-container)
  * [Adopting built-in sidecar containers](#adopting-built-in-sidecar-containers)
    * [Ensure the feature gate is enabled](#ensure-the-feature-gate-is-enabled)
      * [Note](#note)
    * [Check for 3rd party tooling and mutating webhooks](#check-for-3rd-party-tooling-and-mutating-webhooks)
      * [Note](#note)
    * [Automatic injection of sidecars](#automatic-injection-of-sidecars)
  * [Feedback](#feedback)
...
# Adopting Sidecar Containers
 ...
 > 
 > **Context**: This section is relevant for people adopting a new built-in sidecar containers  feature for their workloads. Sidecar container is not a new concept as
