---
id: tutorial/docs-tutorials-hello-minikube.md/docs-tutorials-hello-minikube
title: Hello Minikube
category: tutorial
tags: ["contents", "hello", "minikube", "objectives", "table"]
---
...
* [Hello Minikube](#hello-minikube)
  ...
  * [Check the status of the minikube cluster](#check-the-status-of-the-minikube-cluster)
...
# Hello Minikube
 ...
 > 
 > **Context**: This tutorial shows you how to run a sample app on Kubernetes using minikube. The tutorial provides a container image that uses NGINX to echo back all
...
Last modified November 19, 2025 at 5:42 PM PST: [update text as per review suggestion (ea2a65c214)](https://github.com/kubernetes/website/commit/ea2a65c214dcb8f0cb68fc109bd866ae8a7a6f9e)
