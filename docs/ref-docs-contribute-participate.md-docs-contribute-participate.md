---
id: ref/docs-contribute-participate.md/docs-contribute-participate
title: Participating in SIG Docs
category: ref
tags: ["chairperson", "contents", "participating", "ref", "table"]
---
...
* [Participating in SIG Docs](#participating-in-sig-docs)
  ...
  * [SIG Docs teams and automation](#sig-docs-teams-and-automation)
    * [GitHub teams](#github-teams)
    * [OWNERS files and front-matter](#owners-files-and-front-matter)
...
# Participating in SIG Docs
 ...
 > 
 > **Context**: SIG Docs is one of the special interest groups within the Kubernetes project, focused on writing, updating, and maintaining the documentation for Kube
