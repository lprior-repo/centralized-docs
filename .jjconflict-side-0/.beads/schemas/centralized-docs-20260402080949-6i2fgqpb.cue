...
// Validation schema for bead: centralized-docs-20260402080949-6i2fgqpb
// Title: data: add fixed-size `FileStateRaw` and `UrlStateRaw` pod types
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402080949-6i2fgqpb.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402080949-6i2fgqpb"
  title: "data: add fixed-size `FileStateRaw` and `UrlStateRaw` pod types"
