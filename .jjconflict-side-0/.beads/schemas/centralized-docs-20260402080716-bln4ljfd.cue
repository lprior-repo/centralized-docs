...
// Validation schema for bead: centralized-docs-20260402080716-bln4ljfd
// Title: data: add fixed-size `FileStateRaw` and `UrlStateRaw` pod types
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402080716-bln4ljfd.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402080716-bln4ljfd"
  title: "data: add fixed-size `FileStateRaw` and `UrlStateRaw` pod types"
