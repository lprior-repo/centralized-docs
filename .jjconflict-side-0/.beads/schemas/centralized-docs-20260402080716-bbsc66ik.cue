...
// Validation schema for bead: centralized-docs-20260402080716-bbsc66ik
// Title: data: add `StateReadSession` to enforce one shared read transaction per run
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402080716-bbsc66ik.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402080716-bbsc66ik"
  title: "data: add `StateReadSession` to enforce one shared read transaction per run"
