...
// Validation schema for bead: centralized-docs-20260402083214-sxlfdsqb
// Title: data: add explicit snapshot APIs on `StateReadSession` and `StateDb`
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402083214-sxlfdsqb.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402083214-sxlfdsqb"
  title: "data: add explicit snapshot APIs on `StateReadSession` and `StateDb`"
