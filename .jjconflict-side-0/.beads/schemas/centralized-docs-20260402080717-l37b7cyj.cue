...
// Validation schema for bead: centralized-docs-20260402080717-l37b7cyj
// Title: data: remove LRU backend from `CacheBackendInner` after state migration
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402080717-l37b7cyj.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402080717-l37b7cyj"
  title: "data: remove LRU backend from `CacheBackendInner` after state migration"
