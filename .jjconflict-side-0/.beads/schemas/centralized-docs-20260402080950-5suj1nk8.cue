...
// Validation schema for bead: centralized-docs-20260402080950-5suj1nk8
// Title: data: add `StateReadSession` to enforce one shared read transaction per run
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402080950-5suj1nk8.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402080950-5suj1nk8"
  title: "data: add `StateReadSession` to enforce one shared read transaction per run"
