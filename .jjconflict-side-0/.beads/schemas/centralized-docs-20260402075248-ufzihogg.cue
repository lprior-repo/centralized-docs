...
// Validation schema for bead: centralized-docs-20260402075248-ufzihogg
// Title: calc: add `compute_file_diff` with parallel SHA-256 hashing
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402075248-ufzihogg.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402075248-ufzihogg"
  title: "calc: add `compute_file_diff` with parallel SHA-256 hashing"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      ...
      "Files are classified as changed if either content hash or config hash differs.",
    ]
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      ...
      "A unit test verifies the diff result is deterministic for the same discovered files and known-state inputs.",
    ]
