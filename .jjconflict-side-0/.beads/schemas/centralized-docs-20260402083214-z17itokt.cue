...
// Validation schema for bead: centralized-docs-20260402083214-z17itokt
// Title: action: reuse archived analyses for unchanged files in `run_index`
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402083214-z17itokt.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402083214-z17itokt"
  title: "action: reuse archived analyses for unchanged files in `run_index`"
