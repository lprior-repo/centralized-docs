...
// Validation schema for bead: centralized-docs-20260402080950-s3oozoyj
// Title: data: add explicit snapshot APIs on `StateReadSession` and `StateDb`
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402080950-s3oozoyj.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402080950-s3oozoyj"
  title: "data: add explicit snapshot APIs on `StateReadSession` and `StateDb`"
