...
// Validation schema for bead: centralized-docs-20260402082734-dtz5rsso
// Title: action: wire startup state open and file diff into `run_index`
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402082734-dtz5rsso.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402082734-dtz5rsso"
  title: "action: wire startup state open and file diff into `run_index`"
