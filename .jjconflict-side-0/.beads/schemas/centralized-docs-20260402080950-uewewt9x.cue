...
// Validation schema for bead: centralized-docs-20260402080950-uewewt9x
// Title: action: reuse archived analyses for unchanged files in `run_index`
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402080950-uewewt9x.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402080950-uewewt9x"
  title: "action: reuse archived analyses for unchanged files in `run_index`"
