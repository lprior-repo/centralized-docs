...
chunk_id: ops/general/docs-reference-spec#38-standard
chunk_level: standard
chunk_type: prose
heading: Introduction
token_count: 560
summary: or the identifier following it. The interpretation of the ImportPath is implementation-dependent but it is
---
