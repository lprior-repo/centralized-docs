...
chunk_id: ops/general/docs-concept-how-cue-works-with-json-sch#5-standard
chunk_level: standard
chunk_type: prose
heading: Introduction
token_count: 519
summary: How CUE works with JSON. [/docs/concept/how-cue-works-with-json/]How CUE works with OpenAPI
---
