...
chunk_id: ops/general/docs-concept-how-cue-works-with-go#4-standard
chunk_level: standard
chunk_type: prose
heading: Introduction
token_count: 632
summary: The CUE project believes that its role can be one of interlingua:. a bidirectional bridge between all the formats that CUE speaks,
---
