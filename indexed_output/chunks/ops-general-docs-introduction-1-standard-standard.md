...
chunk_id: ops/general/docs-introduction#1-standard
chunk_level: standard
chunk_type: prose
heading: Introduction
token_count: 515
summary:  * Configuration: values can be combined from different sources.    without one having to import the other
---
