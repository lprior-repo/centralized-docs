...
chunk_id: ops/general/docs-introduction#20-summary
chunk_level: summary
chunk_type: prose
heading: Introduction
token_count: 288
summary: It allows combining constraints from various sources without having. to define any order in which they are to be applied to get
---
