...
// Validation schema for bead: centralized-docs-20260402082734-etunsr4h
// Title: action: wire scrape command to one shared read session and one shutdown commit
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402082734-etunsr4h.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402082734-etunsr4h"
  title: "action: wire scrape command to one shared read session and one shutdown commit"
