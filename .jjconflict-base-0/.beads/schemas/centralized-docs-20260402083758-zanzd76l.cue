...
// Validation schema for bead: centralized-docs-20260402083758-zanzd76l
// Title: action: load archived scrape outputs for unchanged pages and skip downstream stages
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402083758-zanzd76l.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402083758-zanzd76l"
  title: "action: load archived scrape outputs for unchanged pages and skip downstream stages"
