...
// Validation schema for bead: centralized-docs-20260402082447-5p7itjaf
// Title: data: add `StateReadSession` to enforce one shared read transaction per run
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402082447-5p7itjaf.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402082447-5p7itjaf"
  title: "data: add `StateReadSession` to enforce one shared read transaction per run"
