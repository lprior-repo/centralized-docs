...
// Validation schema for bead: centralized-docs-20260402082734-kydxhzvk
// Title: action: migrate watch/apply snapshot persistence from `DocCache` to `StateDb`
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402082734-kydxhzvk.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402082734-kydxhzvk"
  title: "action: migrate watch/apply snapshot persistence from `DocCache` to `StateDb`"
