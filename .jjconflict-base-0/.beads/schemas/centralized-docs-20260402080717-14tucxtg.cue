...
// Validation schema for bead: centralized-docs-20260402080717-14tucxtg
// Title: calc: expose deterministic config hashing and add `compute_file_diff`
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402080717-14tucxtg.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402080717-14tucxtg"
  title: "calc: expose deterministic config hashing and add `compute_file_diff`"
