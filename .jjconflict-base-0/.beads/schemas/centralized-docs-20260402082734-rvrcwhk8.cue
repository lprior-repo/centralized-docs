...
// Validation schema for bead: centralized-docs-20260402082734-rvrcwhk8
// Title: data: add `StateReadSession` to enforce one shared read transaction per run
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402082734-rvrcwhk8.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402082734-rvrcwhk8"
  title: "data: add `StateReadSession` to enforce one shared read transaction per run"
