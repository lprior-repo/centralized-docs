...
// Validation schema for bead: centralized-docs-20260402082447-foaxplcs
// Title: action: wire scrape command to one shared read session and one shutdown commit
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402082447-foaxplcs.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402082447-foaxplcs"
  title: "action: wire scrape command to one shared read session and one shutdown commit"
