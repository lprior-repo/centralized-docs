...
// Validation schema for bead: centralized-docs-20260402083214-0aczwtnc
// Title: data: add fixed-size `FileStateRaw` and `UrlStateRaw` pod types
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402083214-0aczwtnc.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402083214-0aczwtnc"
  title: "data: add fixed-size `FileStateRaw` and `UrlStateRaw` pod types"
