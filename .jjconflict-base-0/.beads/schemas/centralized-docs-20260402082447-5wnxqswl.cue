...
// Validation schema for bead: centralized-docs-20260402082447-5wnxqswl
// Title: data: add explicit snapshot APIs on `StateReadSession` and `StateDb`
//
// This schema validates that implementation is complete.
// Use: cue vet centralized-docs-20260402082447-5wnxqswl.cue implementation.cue

#BeadImplementation: {
  bead_id: "centralized-docs-20260402082447-5wnxqswl"
  title: "data: add explicit snapshot APIs on `StateReadSession` and `StateDb`"
