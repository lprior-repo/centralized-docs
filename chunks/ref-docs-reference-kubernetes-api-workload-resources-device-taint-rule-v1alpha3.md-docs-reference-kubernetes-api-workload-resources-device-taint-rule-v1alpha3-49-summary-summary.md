...
chunk_id: ref/docs-reference-kubernetes-api-workload-resources-device-taint-rule-v1alpha3.md/docs-reference-kubernetes-api-workload-resources-device-taint-rule-v1alpha3#49-summary
chunk_level: summary
chunk_type: prose
heading: DeviceTaintRuleList
token_count: 116
summary: * **name** (*in path*): string, required name of the DeviceTaintRule * **body**: [Patch](https://kubernetes.io/docs/reference/kubernetes-api/common-definitions/patch/#Patch), required * **dryRun**...
---
