...
chunk_id: tutorial/docs-tutorials-kubernetes-basics-expose-expose-intro.md/docs-tutorials-kubernetes-basics-expose-expose-intro#7-standard
chunk_level: standard
chunk_type: prose
heading: Related Pages
token_count: 112
summary: ## Related Pages  - [Use a Service to Access an Application in a Cluster](docs-tasks-access-application-cluster-service-access-application-cluster.md) -...
---
