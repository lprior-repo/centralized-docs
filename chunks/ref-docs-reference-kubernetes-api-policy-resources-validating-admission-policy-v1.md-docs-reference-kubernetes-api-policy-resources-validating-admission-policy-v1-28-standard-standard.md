...
chunk_id: ref/docs-reference-kubernetes-api-policy-resources-validating-admission-policy-v1.md/docs-reference-kubernetes-api-policy-resources-validating-admission-policy-v1#28-standard
chunk_level: standard
chunk_type: prose
heading: ValidatingAdmissionPolicyBinding
token_count: 500
summary: #### Parameters * **name** (*in path*): string, required name of the ValidatingAdmissionPolicy * **pretty** (*in query*): string...
---
