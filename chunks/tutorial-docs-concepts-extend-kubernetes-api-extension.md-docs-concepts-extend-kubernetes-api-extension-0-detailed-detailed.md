...
chunk_id: tutorial/docs-concepts-extend-kubernetes-api-extension.md/docs-concepts-extend-kubernetes-api-extension#0-detailed
chunk_level: detailed
chunk_type: prose
heading: Related Pages
token_count: 565
summary: ## Table of Contents  - [Extending the Kubernetes API](#extending-the-kubernetes-api)   - [Feedback](#feedback)  ---  # Extending the Kubernetes API Custom resources are extensions of the Kubernetes...
---
