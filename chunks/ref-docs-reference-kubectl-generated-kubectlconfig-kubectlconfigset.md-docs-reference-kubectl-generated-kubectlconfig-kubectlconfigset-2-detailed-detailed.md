...
chunk_id: ref/docs-reference-kubectl-generated-kubectlconfig-kubectlconfigset.md/docs-reference-kubectl-generated-kubectlconfig-kubectlconfigset#2-detailed
chunk_level: detailed
chunk_type: table
heading: Parent Options Inherited
token_count: 850
summary: ## Options |-h, --help| || help for set | |--set-raw-bytes tristate[=true]| || When writing a []byte PROPERTY\_VALUE, write the given string directly without base64 decoding. | ## Parent Options...
---
