...
chunk_id: ref/docs-concepts-security-service-accounts.md/docs-concepts-security-service-accounts#7-standard
chunk_level: standard
chunk_type: prose
heading: Use cases for Kubernetes service accounts
token_count: 412
summary: #### Manually retrieve ServiceAccount credentials If you need the credentials for a ServiceAccount to mount in a non-standard location, or for an audience that isn't the API server, use one of the...
---
