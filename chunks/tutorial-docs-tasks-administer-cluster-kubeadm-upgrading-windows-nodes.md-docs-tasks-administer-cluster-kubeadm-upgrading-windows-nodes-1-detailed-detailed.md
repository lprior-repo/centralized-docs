...
chunk_id: tutorial/docs-tasks-administer-cluster-kubeadm-upgrading-windows-nodes.md/docs-tasks-administer-cluster-kubeadm-upgrading-windows-nodes#1-detailed
chunk_level: detailed
chunk_type: code
heading: Feedback
token_count: 898
summary: # Upgrading Windows nodes FEATURE STATE: `Kubernetes v1.18 [beta]` This page explains how to upgrade a Windows node created with kubeadm. ## Before you begin You need to have shell access to all the...
---
