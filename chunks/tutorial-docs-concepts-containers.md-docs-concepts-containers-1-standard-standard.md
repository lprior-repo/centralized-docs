...
chunk_id: tutorial/docs-concepts-containers.md/docs-concepts-containers#1-standard
chunk_level: standard
chunk_type: prose
heading: Container runtimes
token_count: 508
summary: # Containers Technology for packaging an application along with its runtime dependencies. This page will discuss containers and container images, as well as their use in operations and solution...
---
