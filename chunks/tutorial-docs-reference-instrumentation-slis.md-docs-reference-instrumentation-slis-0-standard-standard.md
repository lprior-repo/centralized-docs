...
chunk_id: tutorial/docs-reference-instrumentation-slis.md/docs-reference-instrumentation-slis#0-standard
chunk_level: standard
chunk_type: prose
heading: Table of Contents
token_count: 99
summary: ## Table of Contents  - [Kubernetes Component SLI Metrics](#kubernetes-component-sli-metrics)   - [SLI Metrics](#sli-metrics) - [TYPE kubernetes\_healthcheck gauge](#type-kuberneteshealthcheck-gauge)...
---
