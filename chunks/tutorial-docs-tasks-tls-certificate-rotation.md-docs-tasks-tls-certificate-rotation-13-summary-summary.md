...
chunk_id: tutorial/docs-tasks-tls-certificate-rotation.md/docs-tasks-tls-certificate-rotation#13-summary
chunk_level: summary
chunk_type: prose
heading: Related Pages
token_count: 125
summary: - [Using RBAC Authorization](docs-reference-access-authn-authz-rbac.md) - [Adding entries to Pod /etc/hosts with HostAliases](docs-tasks-network-customize-hosts-file-for-pods.md) - [Change the Access...
---
