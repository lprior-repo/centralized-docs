...
chunk_id: tutorial/docs-tutorials-stateful-application-cassandra.md/docs-tutorials-stateful-application-cassandra#5-standard
chunk_level: standard
chunk_type: prose
heading: Using a StatefulSet to create a Cassandra ring
token_count: 85
summary: #### Note: This example uses the default provisioner for Minikube. Please update the following StatefulSet for the cloud you are working with. [`application/cassandra/cassandra-statefulset.yaml`...
---
