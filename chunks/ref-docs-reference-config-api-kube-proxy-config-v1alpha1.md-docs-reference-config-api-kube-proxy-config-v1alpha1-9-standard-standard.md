...
chunk_id: ref/docs-reference-config-api-kube-proxy-config-v1alpha1.md/docs-reference-config-api-kube-proxy-config-v1alpha1#9-standard
chunk_level: standard
chunk_type: prose
heading: `KubeProxyConfiguration`
token_count: 497
summary: | winkernel contains winkernel-related configuration options. | |`detectLocalMode`**[Required]** [`LocalMode`](#kubeproxy-config-k8s-io-v1alpha1-LocalMode)| detectLocalMode determines mode to use for...
---
