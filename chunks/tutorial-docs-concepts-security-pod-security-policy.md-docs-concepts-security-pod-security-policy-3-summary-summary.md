...
chunk_id: tutorial/docs-concepts-security-pod-security-policy.md/docs-concepts-security-pod-security-policy#3-summary
chunk_level: summary
chunk_type: prose
heading: Table of Contents
token_count: 123
summary: * a 3rd party admission plugin, that you deploy and configure yourself For a migration guide, see [Migrate from PodSecurityPolicy to the Built-In PodSecurity Admission...
---
