...
chunk_id: tutorial/docs-tasks-administer-cluster-kubeadm-upgrading-windows-nodes.md/docs-tasks-administer-cluster-kubeadm-upgrading-windows-nodes#0-detailed
chunk_level: detailed
chunk_type: prose
heading: Table of Contents
token_count: 144
summary: ## Table of Contents  - [Upgrading Windows nodes](#upgrading-windows-nodes)   - [Before you begin](#before-you-begin)     - [Upgrade kubeadm](#upgrade-kubeadm)     - [Drain the node](#drain-the-node)...
---
