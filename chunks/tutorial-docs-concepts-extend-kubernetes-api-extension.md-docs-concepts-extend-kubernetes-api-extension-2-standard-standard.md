...
chunk_id: tutorial/docs-concepts-extend-kubernetes-api-extension.md/docs-concepts-extend-kubernetes-api-extension#2-standard
chunk_level: standard
chunk_type: prose
heading: Related Pages
token_count: 134
summary: ## Related Pages  - [Configure the Aggregation Layer](docs-tasks-extend-kubernetes-configure-aggregation-layer.md) - [Adding entries to Pod /etc/hosts with...
---
