...
chunk_id: ref/docs-reference-kubernetes-api-workload-resources-device-taint-rule-v1alpha3.md/docs-reference-kubernetes-api-workload-resources-device-taint-rule-v1alpha3#9-standard
chunk_level: standard
chunk_type: prose
heading: DeviceTaintRuleList
token_count: 442
summary: #### Parameters * **name** (*in path*): string, required name of the DeviceTaintRule * **pretty** (*in query*): string...
---
