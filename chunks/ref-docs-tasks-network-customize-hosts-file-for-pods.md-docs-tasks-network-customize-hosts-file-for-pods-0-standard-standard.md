...
chunk_id: ref/docs-tasks-network-customize-hosts-file-for-pods.md/docs-tasks-network-customize-hosts-file-for-pods#0-standard
chunk_level: standard
chunk_type: prose
heading: Table of Contents
token_count: 135
summary: ## Table of Contents  - [Adding entries to Pod /etc/hosts with HostAliases](#adding-entries-to-pod-etchosts-with-hostaliases)   - [Default hosts file content](#default-hosts-file-content)   - [Adding...
---
