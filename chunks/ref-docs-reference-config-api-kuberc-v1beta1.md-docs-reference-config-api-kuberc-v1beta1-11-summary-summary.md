...
chunk_id: ref/docs-reference-config-api-kuberc-v1beta1.md/docs-reference-config-api-kuberc-v1beta1#11-summary
chunk_level: summary
chunk_type: table
heading: `AliasOverride`
token_count: 125
summary: * [Preference](#kubectl-config-k8s-io-v1beta1-Preference) AliasOverride stores the alias definitions. |Field|Description| |`name`**[Required]** `string`| name is the name of alias that can only...
---
