...
chunk_id: tutorial/docs-tasks-configure-pod-container-assign-resources.md/docs-tasks-configure-pod-container-assign-resources#6-summary
chunk_level: summary
chunk_type: prose
heading: Related Pages
token_count: 107
summary: - [Adding entries to Pod /etc/hosts with HostAliases](docs-tasks-network-customize-hosts-file-for-pods.md) - [Change the Access Mode of a PersistentVolume to...
---
