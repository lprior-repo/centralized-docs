...
chunk_id: tutorial/docs-tutorials-hello-minikube.md/docs-tutorials-hello-minikube#2-standard
chunk_level: standard
chunk_type: prose
heading: Open the Dashboard
token_count: 425
summary: ## Check the status of the minikube cluster Verify the status of the minikube cluster to ensure all the components are in a running state. ``` `minikube status ` ``` The output from the above command...
---
