...
chunk_id: concept/releases.md/releases#3-standard
chunk_level: standard
chunk_type: prose
heading: Table of Contents
token_count: 414
summary: ### 1.33 **Latest Release:**1.33.10 (released: 2026-03-19) **End of Life:**2026-06-28 **Patch Releases:** [1.33.1](https://git.k8s.io/kubernetes/CHANGELOG/CHANGELOG-1.33.md#v1331),...
---
