...
chunk_id: tutorial/docs-tutorials-hello-minikube.md/docs-tutorials-hello-minikube#9-standard
chunk_level: standard
chunk_type: prose
heading: Related Pages
token_count: 405
summary: ## What's next * Tutorial to *[deploy your first app on Kubernetes with kubectl](/docs/tutorials/kubernetes-basics/deploy-app/deploy-intro/)*. * Learn more about [Deployment...
---
