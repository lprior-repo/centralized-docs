...
chunk_id: ref/docs-reference-kubernetes-api-workload-resources-device-taint-rule-v1alpha3.md/docs-reference-kubernetes-api-workload-resources-device-taint-rule-v1alpha3#41-summary
chunk_level: summary
chunk_type: prose
heading: DeviceTaintRuleList
token_count: 128
summary: * **name** (*in path*): string, required name of the DeviceTaintRule * **body**:...
---
