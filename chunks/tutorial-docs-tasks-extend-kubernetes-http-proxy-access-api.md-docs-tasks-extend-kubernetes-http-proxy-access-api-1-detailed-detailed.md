...
chunk_id: tutorial/docs-tasks-extend-kubernetes-http-proxy-access-api.md/docs-tasks-extend-kubernetes-http-proxy-access-api#1-detailed
chunk_level: detailed
chunk_type: code
heading: Related Pages
token_count: 967
summary: # Use an HTTP Proxy to Access the Kubernetes API # Use an HTTP Proxy to Access the Kubernetes API This page shows how to use an HTTP proxy to access the Kubernetes API. ## Before you begin You need...
---
