---
url: https://docs.aws.amazon.com/step-functions/latest/dg/batch-job-notification.html
title: Manage a batch job with AWS Batch and Amazon SNS
word_count: 455
filtered: true
elements_removed: 0
density_score: 0.88
...
Manage a batch job with AWS Batch and Amazon SNS - AWS Step Functions
Manage a batch job with AWS Batch and Amazon SNS - AWS Step Functions
[](https://docs.aws.amazon.com/pdfs/step-functions/latest/dg/step-functions-dg.pdf#batch-job-notification)
[Step 1: Create the state machine](#batch-job-create)[Step 2: Run the demo state machine](#sample-container-start-execution)
