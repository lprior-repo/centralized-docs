---
url: https://docs.aws.amazon.com/step-functions/latest/dg/sample-eks-cluster.html
title: Create and manage an Amazon EKS cluster with a node group
word_count: 489
filtered: true
elements_removed: 0
density_score: 0.89
...
Create and manage an Amazon EKS cluster with a node group - AWS Step Functions
Create and manage an Amazon EKS cluster with a node group - AWS Step Functions
[](https://docs.aws.amazon.com/pdfs/step-functions/latest/dg/step-functions-dg.pdf#sample-eks-cluster)
[Step 1: Create the state machine](#sample-eks-cluster-create)[Step 2: Run the demo state machine](#sample-eks-cluster-start-execution)
# Create and manage an Amazon EKS cluster with a node group
This sample project demonstrates how to use Step Functions and Amazon Elastic Kubernetes Service to create an Amazon EKS cluster
with a node group, run a job on Amazon EKS, then examine the output. When finished, it removes the
...
a certain level of usage. For more information about AWS costs and the Free Tier, see [Amazon EKS Pricing](https://aws.amazon.com/eks/pricing/).
