---
url: https://docs.aws.amazon.com/step-functions/latest/dg/sample-apigateway-workflow.html
title: Interact with an API managed by API Gateway
word_count: 410
filtered: true
elements_removed: 0
density_score: 0.89
...
Interact with an API managed by API Gateway - AWS Step Functions
[](https://docs.aws.amazon.com/pdfs/step-functions/latest/dg/step-functions-dg.pdf#sample-apigateway-workflow)
[Step 1: Create the state](#sample-apigateway-workflow-create)[Step 2: Run the demo state machine](#sample-apigateway-workflow-start-execution)
