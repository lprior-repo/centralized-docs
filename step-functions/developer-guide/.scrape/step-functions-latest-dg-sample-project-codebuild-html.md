---
url: https://docs.aws.amazon.com/step-functions/latest/dg/sample-project-codebuild.html
title: Build an AWS CodeBuild project using Step Functions
word_count: 390
filtered: true
elements_removed: 0
density_score: 0.89
...
Build an AWS CodeBuild project using Step Functions - AWS Step Functions
Build an AWS CodeBuild project using Step Functions - AWS Step Functions
[](https://docs.aws.amazon.com/pdfs/step-functions/latest/dg/step-functions-dg.pdf#sample-project-codebuild)
[Step 1: Create the state machine](#sample-project-codebuild-create)[Step 2: Run the demo state machine](#sample-project-codebuild-start-execution)
