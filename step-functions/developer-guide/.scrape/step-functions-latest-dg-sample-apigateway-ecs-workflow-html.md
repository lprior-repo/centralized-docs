---
url: https://docs.aws.amazon.com/step-functions/latest/dg/sample-apigateway-ecs-workflow.html
title: Call a microservice running on Fargate using API Gateway integration
word_count: 431
filtered: true
elements_removed: 0
density_score: 0.89
...
Call a microservice running on Fargate using API Gateway integration - AWS Step Functions
Call a microservice running on Fargate using API Gateway integration - AWS Step Functions
[](https://docs.aws.amazon.com/pdfs/step-functions/latest/dg/step-functions-dg.pdf#sample-apigateway-ecs-workflow)
[Step 1: Create the state machine](#sample-apigateway-ecs-workflow-create)[Step 2: Run the demo state machine](#sample-apigateway-ecs-workflow-start-execution)
# Call a microservice running on Fargate using API Gateway integration
This sample project demonstrates how to use Step Functions to make a call to API Gateway in order to
interact with a service on AWS Fargate, and also to check whether the call succeeded.
