---
url: https://docs.aws.amazon.com/step-functions/latest/dg/sample-start-workflow.html
title: Start a workflow within a workflow with Step Functions and Lambda
word_count: 410
filtered: true
elements_removed: 0
density_score: 0.89
...
Start a workflow within a workflow with Step Functions and Lambda - AWS Step Functions
Start a workflow within a workflow with Step Functions and Lambda - AWS Step Functions
[](https://docs.aws.amazon.com/pdfs/step-functions/latest/dg/step-functions-dg.pdf#sample-start-workflow)
[Step 1: Create the state machine](#sample-start-workflow-create)[Step 2: Run the demo state machine](#sample-start-workflow-start-execution)
...
machine executions. For information about starting state machine executions from another state machine, see [Start workflow executions from a task state in Step Functions](./concepts-nested-workflows.html).
