---
url: https://docs.aws.amazon.com/step-functions/latest/dg/sample-query-large-datasets.html
title: Query large datasets using an AWS Glue crawler
word_count: 447
filtered: true
elements_removed: 0
density_score: 0.88
...
Query large datasets using an AWS Glue crawler - AWS Step Functions
Query large datasets using an AWS Glue crawler - AWS Step Functions
[](https://docs.aws.amazon.com/pdfs/step-functions/latest/dg/step-functions-dg.pdf#sample-query-large-datasets)
[Step 1: Create the state machine](#sample-query-large-datasets-create)[Step 2: Run the demo state machine](#sample-query-large-datasets-start-execution)
