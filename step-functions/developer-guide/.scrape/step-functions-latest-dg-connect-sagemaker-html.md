---
url: https://docs.aws.amazon.com/step-functions/latest/dg/connect-sagemaker.html
title: Create and manage Amazon SageMaker AI jobs with Step Functions
word_count: 1501
filtered: true
elements_removed: 0
density_score: 0.75
...
Create and manage Amazon SageMaker AI jobs with Step Functions - AWS Step Functions
Create and manage Amazon SageMaker AI jobs with Step Functions - AWS Step Functions
[](https://docs.aws.amazon.com/pdfs/step-functions/latest/dg/step-functions-dg.pdf#connect-sagemaker)
[Supported APIs](#connect-sagemaker-api)[Transform Job
Example](#sagemaker-example-transform)[Training Job
Example](#sagemaker-example-training)[Labeling Job
Example](#sagemaker-example-labeling)[Processing Job
Example](#sagemaker-example-processing)[IAM policies](#sagemaker-iam)
...
* [`CreateHyperParameterTuningJob`](https://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateHyperParameterTuningJob.html) - Supports the `[.sync](./connect-to-resource.html#connect-sync)` integration pattern.
* [`CreateLabelingJob`](https://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateLabelingJob.html) - Supports the `[.sync](./connect-to-resource.html#connect-sync)` integration pattern.
* [`CreateModel`](https://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateModel.html)
* [`CreateProcessingJob`](https://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateProcessingJob.html) - Supports the `[.sync](./connect-to-resource.html#connect-sync)` integration pattern.
* [`CreateTrainingJob`](https://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateTrainingJob.html) - Supports the `[.sync](./connect-to-resource.html#connect-sync)` integration pattern.
* [`CreateTransformJob`](https://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateTransformJob.html) - Supports the `[.sync](./connect-to-resource.html#connect-sync)` integration pattern.
...
created role. For more information, see this example IAM policy: [CreateTrainingJob](#sagemaker-iam-createtrainingjob).
...
"HyperParameters":{
"mode":"batch\_skipgram",
"epochs":"5",
"min\_count":"5",
"sampling\_threshold":"0.0001",
